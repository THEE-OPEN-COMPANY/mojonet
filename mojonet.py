...
def main():
    ...
    try:
        ...
        print("---")
        print("Please report it:https://github.com/THEE-OPEN-COMPANY/mojonet")
...
def displayErrorMessage(err, error_log_path):
    ...
    res = ctypes.windll.user32.MessageBoxW(
        0, err_title, "MojoNet error", MB_YESNOCANCEL | MB_ICONEXCLAIMATION)
    if res == ID_YES:
        import webbrowser
        report_url = "https://github.com/THEE-OPEN-COMPANY/mojonet"
        webbrowser.open(report_url % urllib.parse.quote(
            "Unhandled exception: %s" % err_message))
...
def start():
    ...
    os.chdir(app_dir)  # Change working dir to MojoNet.py dir
    # External liblary directory
