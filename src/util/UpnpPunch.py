...
def _get_local_ips():
    def method1():
        try:
            ...
            # https://github.com/sirMackk/MojoNet/commit/fdcd15cf8df0008a2070647d4d28ffedb503fba2#commitcomment-9863928
...
if __name__ == "__main__":
    ...
    s = time.time()
    print("Opening port...")
    print("Success:", ask_to_open_port(15443, "MojoNet", protos=["TCP"]))
    print("Done in", time.time() - s)

    print("Closing port...")
    print("Success:", ask_to_close_port(15443, "MojoNet", protos=["TCP"]))
    print("Done in", time.time() - s)
