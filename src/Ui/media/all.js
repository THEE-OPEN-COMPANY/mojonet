...
(function () {
  ...
  mojoWebsocket = (function () {
    function mojoWebsocket(url) {
    ...
    mojoWebsocket.prototype.init = function () {
      return this;
    };

    mojoWebsocket.prototype.connect = function () {
    ...
    mojoWebsocket.prototype.onMessage = function (e) {
      var cmd, message;
    ...
    mojoWebsocket.prototype.route = function (cmd, message) {
      return this.log("Unknown command", message);
    };

    mojoWebsocket.prototype.response = function (to, result) {
      return this.send({
        cmd: "response",
        to: to,
        result: result,
    ...
    mojoWebsocket.prototype.cmd = function (cmd, params, cb) {
      if (params == null) {
        params = {};
      }
      if (cb == null) {
    ...
    mojoWebsocket.prototype.send = function (message, cb) {
      if (cb == null) {
        cb = null;
      }
      if (message.id == null) {
    ...
    mojoWebsocket.prototype.log = function () {
      var args;
      args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      return console.log.apply(
        console,
        ["[mojoWebsocket]"].concat(slice.call(args))
      );
    };

    mojoWebsocket.prototype.onOpenWebsocket = function (e) {
    ...
    mojoWebsocket.prototype.onErrorWebsocket = function (e) {
      this.log("Error", e);
    ...
    mojoWebsocket.prototype.onCloseWebsocket = function (e, reconnect) {
      if (reconnect == null) {
        reconnect = 10000;
      }
      this.log("Closed", e);
    ...
    return mojoWebsocket;
  })();

  window.mojoWebsocket = mojoWebsocket;
}.call(this));
...
jQuery.cssHooks["scale"] = {
  ...
  set: function (elem, val) {
    ...
    var transforms = window
      .getComputedStyle(elem)
      [transform_property].match(/[0-9\.]+/g);
    if (transforms) {
      transforms[0] = val;
      transforms[3] = val;
  ...
  Infopanel = (function () {
    ...
    Infopanel.prototype.updateEvents = function () {
      ...
      if (this.elem.hasClass("closed")) {
        ...
        return this.elem.find(".close").on(
          "click",
          (function (_this) {
            return function () {
              _this.onClosed();
...
(function () {
  ...
  Loading = (function () {
    ...
    Loading.prototype.hideProgress = function () {
      ...
      return (this.timer_hide = setTimeout(
        (function (_this) {
          return function () {
            return $(".progressbar")
              .css({
    ...
    Loading.prototype.showTooLarge = function (site_info) {
      ...
      if ($(".console .button-setlimit").length === 0) {
        line = this.printLine(
          "Site size: <b>" +
            parseInt(site_info.settings.size / 1024 / 1024) +
            "MB</b> is larger than default allowed " +
            parseInt(site_info.size_limit) +
            "MB",
          "warning"
        );
        button = $(
          "<a href='#Set+limit' class='button button-setlimit'>" +
            ("Open site and set size limit to " +
              site_info.next_size_limit +
              "MB") +
            "</a>"
        );
        button.on(
    ...
    Loading.prototype.showTrackerTorBridge = function (server_info) {
      var button, line;
      if (
        $(".console .button-settrackerbridge").length === 0 &&
        !server_info.tor_use_meek_bridges
      ) {
        line = this.printLine("Tracker connection error detected.", "error");
        button = $(
          "<a href='#Enable+Tor+bridges' class='button button-settrackerbridge'>" +
        ...
        if (!server_info.tor_has_meek_bridges) {
          ...
          return this.printLine(
            "No meek bridge support in your client, please <a href='https://github.com/HelloMojoNet/MojoNet#how-to-join'>download the latest bundle</a>.",
            "warning"
          );
        }
      }
    ...
    Loading.prototype.printLine = function (text, type) {
      ...
      line = $("<div class='console-line'>" + text + "</div>").appendTo(
        ".loadingscreen .console"
      );
      if (type === "warning") {
  ...
  Notifications = (function () {
        ...
        (function (_this) {
          return function () {
            _this.add(
              "connection",
              "error",
              "Connection lost to <b>UiServer</b> on <b>localhost</b>!"
            );
            return _this.add(
              "message-Anyone",
              "info",
        ...
        (function (_this) {
          return function () {
            return _this.add(
              "connection",
              "done",
              "<b>UiServer</b> connection recovered.",
              5000
            );
          };
        })(this),
    ...
    Notifications.prototype.add = function (id, type, body, timeout) {
      ...
      if (typeof body === "string") {
        $(".body", elem).html(
          "<div class='message'><span class='multiline'>" +
            body +
            "</span></div>"
        );
      } else {
    ...
    Notifications.prototype.log = function () {
      ...
      return console.log.apply(
        console,
        ["[Notifications]"].concat(slice.call(args))
      );
    };
...
(function () {
  ...
  Wrapper = (function () {
    function Wrapper(ws_url) {
      ...
      this.infopanel.onClosed = (function (_this) {
        return function () {
          return _this.ws.cmd("siteSetSettingsValue", [
      ...
      this.ws = new mojoWebsocket(ws_url);
      ...
      this.allowed_event_constructors = [
        window.MouseEvent,
    ...
    Wrapper.prototype.verifyEvent = function (allowed_target, e) {
      ...
      if (
        ((ref = e.originalEvent.constructor),
        indexOf.call(this.allowed_event_constructors, ref) < 0)
      ) {
        throw (
          "Invalid event constructor: " +
          e.constructor +
          " not in " +
          JSON.stringify(this.allowed_event_constructors)
        );
      }
    ...
    Wrapper.prototype.onMessageInner = function (e) {
      ...
      if (
        window.postmessage_nonce_security &&
        message.wrapper_nonce !== window.wrapper_nonce
      ) {
        this.log(
          "Message nonce error:",
          message.wrapper_nonce,
          "!=",
          window.wrapper_nonce
        );
        return;
      }
    ...
    Wrapper.prototype.handleMessage = function (message) {
      ...
      if (cmd === "innerReady") {
        ...
        if (message.id < 1000000) {
          if (
            message.cmd === "fileWrite" &&
            !this.modified_panel_updater_timer &&
            (typeof site_info !== "undefined" && site_info !== null
              ? (ref = site_info.settings) != null
                ? ref.own
                : void 0
              : void 0)
          ) {
            this.modified_panel_updater_timer = setTimeout(
              (function (_this) {
                return function () {
    ...
    Wrapper.prototype.displayOpenerDialog = function () {
      var elem;
      elem = $(
        "<div class='opener-overlay'><div class='dialog'>You have opened this page by clicking on a link. Please, confirm if you want to load this site.<a href='?' target='_blank' class='button'>Open site</a></div></div>"
      );
    ...
    Wrapper.prototype.actionWebNotification = function (message) {
      return $.when(this.event_site_info).done(
        (function (_this) {
          return function () {
            var res;
    ...
    Wrapper.prototype.actionPermissionAdd = function (message) {
      ...
      return $.when(this.event_site_info).done(
        (function (_this) {
          return function () {
            if (
              indexOf.call(_this.site_info.settings.permissions, permission) >=
              0
            ) {
              return false;
            }
            return _this.ws.cmd(
              ...
              function (permission_details) {
                return _this.displayConfirm(
                  "This site requests permission:" +
                    (" <b>" + _this.toHtmlSafe(permission) + "</b>") +
                    ("<br><small style='color: #4F4F4F'>" +
                      permission_details +
                      "</small>"),
                  "Grant",
                  function () {
    ...
    Wrapper.prototype.displayConfirm = function (body, captions, cb) {
      ...
      body = $(
        "<span class='message-outer'><span class='message'>" +
          body +
          "</span></span>"
      );
      ...
      for (i = j = 0, len = captions.length; j < len; i = ++j) {
        ...
        button = $("<a></a>", {
          href: "#" + caption,
          class:
            "button button-confirm button-" + caption + " button-" + (i + 1),
          "data-value": i + 1,
        });
        button.text(caption);
        fn(button);
    ...
    Wrapper.prototype.displayPrompt = function (
      message,
      type,
      caption,
      placeholder,
        ...
        setTimeout(
          (function (_this) {
            return function () {
              ...
              elem
                .removeClass("notification-done")
                .addClass("notification-error");
              return $(".notification-icon .icon-success", elem)
    ...
    Wrapper.prototype.actionSetViewport = function (message) {
      ...
      if ($("#viewport").length > 0) {
        ...
        return $('<meta name="viewport" id="viewport">')
          .attr("content", this.toHtmlSafe(message.params))
          .appendTo("head");
      }
    };
        ...
        (function (_this) {
          return function () {
            ...
            data = localStorage.getItem(
              "site." +
                _this.site_info.address +
                "." +
                _this.site_info.auth_address
            );
            if (!data) {
              ...
              if (data) {
                ...
                _this.log(
                  "Migrated LocalStorage from global to auth_address based"
                );
              }
            }
            if (data) {
    ...
    Wrapper.prototype.onOpenWebsocket = function (e) {
      ...
      if (this.ws_error) {
        this.notifications.add(
          "connection",
          "done",
          "Connection with <b>UiServer Websocket</b> recovered.",
          6000
        );
      ...
      return setTimeout(
        (function (_this) {
          return function () {
            ...
            if (e && e.code === 1000 && e.wasClean === false) {
              return (_this.ws_error = _this.notifications.add(
                "connection",
                "error",
                "UiServer Websocket error, please reload the page."
              ));
              ...
              return (_this.ws_error = _this.notifications.add(
                "connection",
                "error",
                "Connection with <b>UiServer Websocket</b> was lost. Reconnecting..."
              ));
            }
          };
        })(this),
    ...
    Wrapper.prototype.onPageLoad = function (e) {
      ...
      if (this.ws.ws.readyState === 1 && !this.site_info) {
        ...
        this.site_info &&
        ((ref = this.site_info.content) != null ? ref.title : void 0) != null &&
        !this.is_title_changed
      ) {
        window.document.title = this.site_info.content.title + " - MojoNet";
      ...
      return this.ws.cmd(
        ...
        (function (_this) {
          return function (site_info) {
            ...
            if (
              site_info.settings.size > site_info.size_limit * 1024 * 1024 &&
              !_this.loading.screen_visible
            ) {
              _this.displayConfirm(
                "Site is larger than allowed: " +
                  (site_info.settings.size / 1024 / 1024).toFixed(1) +
                  "MB/" +
                  site_info.size_limit +
                  "MB",
                "Set limit to " + site_info.next_size_limit + "MB",
                function () {
                  return _this.ws.cmd(
                    "siteSetLimit",
                    [site_info.next_size_limit],
                    function (res) {
                      if (res === "ok") {
                        return _this.notifications.add(
                          "size_limit",
                          "done",
                          "Site storage limit modified!",
                          5000
                        );
                      }
                    }
            ...
            if (
              ((ref = site_info.content) != null ? ref.title : void 0) !=
                null &&
              !_this.is_title_changed
            ) {
              window.document.title = site_info.content.title + " - MojoNet";
    ...
    Wrapper.prototype.setSiteInfo = function (site_info) {
      ...
      if (site_info.event != null) {
        if (site_info.event[0] === "file_added" && site_info.bad_files) {
          this.loading.printLine(
            site_info.bad_files + " files needs to be downloaded"
          );
          ...
          if (site_info.event[1] === window.file_inner_path) {
            ...
            if (site_info.content && !this.is_title_changed) {
              ...
              this.log(
                "Required file " +
                  window.file_inner_path +
                  " done, setting title to",
            ...
            if (!window.show_loadingscreen) {
              this.notifications.add(
                "modified",
                "info",
                "New version of this page has just released.<br>Reload to see the modified content."
              );
            }
          }
          ...
          if (site_info.settings.size > site_info.size_limit * 1024 * 1024) {
            ...
            this.loading.printLine(
              site_info.event[1] + " download failed",
              "error"
            );
          }
      ...
      if (
        (site_info != null
          ...
          : void 0) &&
        (site_info != null
          ? (ref1 = site_info.settings) != null
            ? ref1.modified
            : void 0
          : void 0) !==
          ((ref2 = this.site_info) != null
      ...
      return this.ws.cmd(
        ...
        (function (_this) {
          return function (res) {
            ...
            if (num > 0) {
              closed =
                _this.site_info.settings.modified_files_notification === false;
              _this.infopanel.show(closed);
            } else {
              _this.infopanel.hide();
            }
            if (num > 0) {
              _this.infopanel.setTitle(
                res.modified_files.length +
                  " modified file" +
                  (num > 1 ? "s" : ""),
    ...
    Wrapper.prototype.setAnnouncerInfo = function (announcer_info) {
      ...
      status_line =
        "Trackers announcing: " +
        status_db.announcing.length +
        ", error: " +
        status_db.error.length +
        ", done: " +
      ...
      if (
        status_db.error.length >
          status_db.announced.length + status_db.announcing.length &&
        status_db.announced.length < 3
      ) {
    ...
    Wrapper.prototype.updateProgress = function (site_info) {
      if (site_info.tasks > 0 && site_info.started_task_num > 0) {
        return this.loading.setProgress(
          1 -
            Math.max(site_info.tasks, site_info.bad_files) /
              site_info.started_task_num
        );
      } else {
  ...
  origin =
    window.server_url || window.location.href.replace(/(\:\/\/.*?)\/.*/, "$1");
  ...
  ws_url =
    proto.ws +
    ":" +
    origin.replace(proto.http + ":", "") +
    "/MojoNet-Internal/Websocket?wrapper_key=" +
    window.wrapper_key;

  window.wrapper = new Wrapper(ws_url);
}.call(this));

/* ---- WrappermojoFrame.coffee ---- */

(function () {
  var WrappermojoFrame,
    bind = function (fn, me) {
      return function () {
        return fn.apply(me, arguments);
      };
  ...
  WrappermojoFrame = (function () {
    function WrappermojoFrame(wrapper) {
    ...
    WrappermojoFrame.prototype.cmd = function (cmd, params, cb) {
      if (params == null) {
        params = {};
      }
      if (cb == null) {
    ...
    WrappermojoFrame.prototype.response = function (to, result) {
      return this.wrapperResponse(to, result);
    };

    WrappermojoFrame.prototype.isProxyRequest = function () {
      return window.location.pathname === "/";
    };

    WrappermojoFrame.prototype.certSelectGotoSite = function (elem) {
      var href;
      href = $(elem).attr("href");
      if (this.isProxyRequest()) {
        return $(elem).attr("href", "http://mojo" + href);
      }
    };

    return WrappermojoFrame;
  })();

  window.mojoframe = new WrappermojoFrame(window.wrapper);
}.call(this));

/* ---- mojoSiteTheme.coffee ---- */
...
(function () {
  ...
  changeColorScheme = function (theme) {
    mojoframe.cmd("userGetGlobalSettings", [], function (user_settings) {
  ...
  displayNotification = function (arg) {
    ...
    mojoframe.cmd("siteInfo", [], function (site_info) {
      if (indexOf.call(site_info.settings.permissions, "ADMIN") >= 0) {
        mojoframe.cmd("wrapperNotification", [
          "info",
          "Your system's theme has been changed.<br>Please reload site to use it.",
        ]);
      } else {
        mojoframe.cmd("wrapperNotification", [
          "info",
          "Your system's theme has been changed.<br>Please open mojoHello to use it.",
        ]);
      }
    });
  };
