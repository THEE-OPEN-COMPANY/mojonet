...
class TestUser:
    def testAddress(self, user):
        ...
        assert user.getAddressAuthIndex(
            "15E5rhcAUD69WbiYsYARh4YHJ4sLm2JEyc") == address_index
    ...
    def testCert(self, user):
        ...
        assert not user.getAuthAddress(
            "1EU1tbG9oC1A8jz2ouVwGZyQ5asrNsE4Vr") == cert_auth_address
        assert user.getAuthAddress(
            "1EU1tbG9oC1A8jz2ouVwGZyQ5asrNsE4Vr") == "1MyJgYQjeEkR9QD66nkfJc9zqi9uUy5Lr2"
