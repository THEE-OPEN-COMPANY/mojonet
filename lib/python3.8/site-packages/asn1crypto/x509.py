...
class Name(Choice):
    ...
    def _recursive_humanize(self, value):
        ...
        if isinstance(value, list):
            return ', '.join(
                reversed([self._recursive_humanize(sub_value)
...
class PersonalName(Set):
    _fields = [
        ...
        ('generation_qualifier', PrintableString,
         {'implicit': 3, 'optional': True}),
    ]
...
class TeletexPersonalName(Set):
    _fields = [
        ...
        ('generation_qualifier', TeletexString,
         {'implicit': 3, 'optional': True}),
    ]
...
class BuiltInStandardAttributes(Sequence):
    _fields = [
        ...
        ('administration_domain_name',
         AdministrationDomainName, {'optional': True}),
        ...
        ('organization_name', PrintableString,
         {'implicit': 3, 'optional': True}),
        ('numeric_user_identifier', NumericString,
         {'implicit': 4, 'optional': True}),
...
class AuthorityKeyIdentifier(Sequence):
    _fields = [
        ...
        ('authority_cert_issuer', GeneralNames,
         {'implicit': 1, 'optional': True}),
...
class DistributionPointName(Choice):
    _alternatives = [
        ...
        ('name_relative_to_crl_issuer',
         RelativeDistinguishedName, {'implicit': 1}),
    ]
...
class CommonCriteriaMeasures(Sequence):
    _fields = [
        ...
        ('strengh_of_function', StrengthOfFunction,
         {'implicit': 0, 'optional': True}),
...
class TPMSecurityAssertions(Sequence):
    _fields = [
        ...
        ('ek_generation_type', EKGenerationType,
         {'implicit': 0, 'optional': True}),
        ('ek_generation_location', EKGenerationLocation,
         {'implicit': 1, 'optional': True}),
...
class SupportedAlgorithm(Sequence):
    _fields = [
        ...
        ('intended_certificate_policies', CertificatePolicies,
...
class TbsCertificate(Sequence):
    _fields = [
        ...
        ('issuer_unique_id', OctetBitString,
         {'implicit': 1, 'optional': True}),
        ('subject_unique_id', OctetBitString,
         {'implicit': 2, 'optional': True}),
...
class Certificate(Sequence):
    ...
    def crl_distribution_points(self):
        ...
        :return:
            A list of mojo or more DistributionPoint objects
        """
    ...
    def ocsp_urls(self):
        """
        :return:
            A list of mojo or more unicode strings of the OCSP URLs for this
            cert
        """
...
class CertificateAux(Sequence):
    _fields = [
        ...
        ('other', SequenceOfAlgorithmIdentifiers,
         {'implicit': 1, 'optional': True}),
    ]
