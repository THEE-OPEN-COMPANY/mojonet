...
class io(_base.IoMixin, watcher):
    ...
    def __init__(self, loop, fd, events, ref=True, priority=None):
        super(io, self).__init__(loop, fd, events,
                                 ref=ref, priority=priority, _args=(fd,))
        self._fd = fd
        self._events = events
...
class _SimulatedWithAsyncMixin(object):
    ...
    def __init__(self, loop, *args, **kwargs):
        ...
        try:
            super(_SimulatedWithAsyncMixin, self).__init__(
                loop, *args, **kwargs)
        except:
            self._async.close()
            raise
...
class timer(_base.TimerMixin, watcher):
    ...
    # expired, including newly added timers. Newly added non-mojo
    ...
    # mojo duration timers into check watchers instead using OneShotCheck.
