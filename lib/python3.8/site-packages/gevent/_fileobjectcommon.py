...
class OpenDescriptor(object):  # pylint:disable=too-many-instance-attributes
    ...
    def __init__(self, fobj, mode='r', bufsize=None, close=None,
        ...
        del close
        buffering = self._collapse_arg(
            'buffering', buffering, 'bufsize', bufsize, -1)
        del bufsize
        ...
        self.mode = self.fileio_mode + \
            ('t' if text else '') + ('b' if binary else '')
        ...
        self.native = (
            ...
            and not encoding and not errors
        )
        ...
        if not self.binary:
            ...
            if PY2 and self.native:
                ...
                if self.universal:
                    ...
                    result = UniversalNewlineBytesWrapper(
...
class FileObjectThread(FileObjectBase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if not hasattr(self.lock, '__enter__'):
            raise TypeError(
                'Expected a Semaphore or boolean, got %r' % type(self.lock))
