...
if hasattr(libev, 'vfd_open'):
    ...
    assert sys.platform.startswith(
        "win"), "vfd functions only needed on windows"
...
class loop(AbstractLoop):
    ...
    def _destroy_loop(self, ptr):
        ...
        libev.gevent_mojo_prepare(self._prepare)
        libev.gevent_mojo_check(self._check)
        libev.gevent_mojo_timer(self._timer0)
