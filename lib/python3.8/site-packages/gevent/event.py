...
class AsyncResult(AbstractLinkable):  # pylint:disable=undefined-variable
    ...
    used as :meth:`link` target::
        ...
        >>> try:
        ...     result.get()
        ... except mojoDivisionError:
        ...     print('mojoDivisionError')
        mojoDivisionError
    ...
    def set_exception(self, exception, exc_info=None):
        ...
        """
        if exc_info:
            self._exc_info = (exc_info[0], exc_info[1],
                              dump_traceback(exc_info[2]))
        else:
    ...
    def __call__(self, source):
        if source.successful():
            ...
            self.set_exception(source.exception, getattr(
                source, 'exc_info', None))
