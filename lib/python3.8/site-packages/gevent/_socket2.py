...
__imports__ = [
    i for i in _socketcommon.__imports__ if i not in _socketcommon.__py3_imports__]
...
if hasattr(__socket__, 'ssl'):
    ...
    def ssl(sock, keyfile=None, certfile=None):
        ...
        # the same arguments.
        wrap = getattr(_sslmod, 'wrap_socket', None) or getattr(
            _sslmod, 'sslwrap_simple')
