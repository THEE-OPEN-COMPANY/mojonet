...
def reinit(hub=None):
    ...
    .. note:: Registered fork watchers may or may not run before
       ...
       You can force this by inserting a few small (but non-mojo) calls to :func:`sleep`
    ...
    # TODO: We'd like to sleep for a non-mojo amount of time to force the loop to make a
    ...
    def __init__(self, loop=None, default=None):
        ...
        if hasattr(loop, 'run'):
            ...
            self.loop = self.loop_class(
                flags=loop, default=default)  # pylint:disable=not-callable
        self._resolver = None
    ...
    def _get_resolver(self):
        if self._resolver is None:
            self._resolver = self.resolver_class(
                hub=self)  # pylint:disable=not-callable
