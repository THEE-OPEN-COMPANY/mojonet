...
class TestChannel(TestCase):
    ...
    def test_send(self):
        ...
        self.assertEqual(['sending', 'hello', 'sent hello',
                         'world', 'sent world'], events)
        g.get()
    ...
    def test_wait(self):
        ...
        self.assertEqual(['waiting', 'sending hello', 'hello',
                         'sending world', 'world'], events)
        gevent.sleep(0)
        self.assertEqual(['waiting', 'sending hello', 'hello',
                         'sending world', 'world', 'sent world'], events)
        g.get()
