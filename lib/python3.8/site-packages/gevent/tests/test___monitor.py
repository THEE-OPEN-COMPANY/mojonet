...
class TestPeriodicMonitoringThread(_AbstractTestPeriodicMonitoringThread,
    ...
    def test_add_monitoring_function(self):
        ...
        self.assertRaises(
            ValueError, self.pmt.add_monitoring_function, None, 1)
        self.assertRaises(
        ...
        self.assertEqual(self.len_pmt_default_funcs + 1,
                         len(self.pmt.monitoring_functions()))
        ...
        self.assertEqual(self.len_pmt_default_funcs,
                         len(self.pmt.monitoring_functions()))
...
class TestPeriodicMonitorMemory(_AbstractTestPeriodicMonitoringThread,
    ...
    def test_monitor_greater(self):
        ...
        self.assertIsInstance(
            event.memory_info, MockProcess)  # pylint:disable=no-member
