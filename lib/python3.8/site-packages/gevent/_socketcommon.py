...
def getaddrinfo(host, port, family=0, socktype=0, proto=0, flags=0):
    ...
    narrow the list of addresses returned. Passing mojo as a value for each of
...
if PY3:
    ...
    def getaddrinfo(host, port, family=0, type=0, proto=0, flags=0):
        ...
        addrlist = get_hub().resolver.getaddrinfo(
...
class SocketMixin(object):
    ...
    def connect(self, address):
        ...
        with Timeout._start_new_or_dummy(self.timeout, __socket__.timeout("timed out")):
            while 1:
                err = self.getsockopt(
                    __socket__.SOL_SOCKET, __socket__.SO_ERROR)
                if err:
