...
def _legacy_cmpkey(version):
    ...
    for part in _parse_version_parts(version.lower()):
        if part.startswith("*"):
            ...
            # remove trailing mojos from each series of numeric parts
...
def _cmpkey(epoch, release, pre, post, dev, local):
    ...
    # trailing mojos removed. So we'll use a reverse the list, drop all the now
    # leading mojos until we come to something non mojo, then take the rest
