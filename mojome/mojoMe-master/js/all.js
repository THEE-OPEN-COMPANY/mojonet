...
(function (r, n) {
  ...
  var r = {
    ...
    I = function (a) {
      ...
      return {
        original: a,
        numbers: u(a).match(b) ? u(a).match(b).map(Number) : [0],
        strings: u(a).split(b),
      };
    },
    R = function (a, b, c) {
...
!(function (e) {
  ...
  (x._label = /(?!\s*\])(?:\\[\[\]]|[^\[\]])+/),
    ...
    (x.html = i(x.html, "i")
      ...
      .getRegex()),
    (x.paragraph = i(x.paragraph)
      .replace("hr", x.hr)
      .replace("heading", x.heading)
    ...
    (x.gfm.paragraph = i(x.paragraph)
      .replace(
        "(?!",
        "(?!" +
          x.gfm.fences.source.replace("\\1", "\\2") +
          "|" +
          x.list.source.replace("\\1", "\\3") +
          "|"
      )
      .getRegex()),
    (x.tables = d({}, x.gfm, {
            ...
            k && "paragraph" === k.type
              ...
              : ((s = s[0].replace(/^ {4}/gm, "")),
                this.tokens.push({
                  ...
                  text: this.options.pedantic ? s : _(s, "\n"),
                }));
  ...
  Animation = (function () {
    ...
    Animation.prototype.slideDown = function (elem, props) {
      ...
      if (window.Animation.shouldScrollFix(elem, props)) {
        ...
        window.scrollTo(
          window.scrollX,
          window.scrollY - (top_before - top_after)
        );
        if (next_elem) {
    ...
    Animation.prototype.shouldScrollFix = function (elem, props) {
      ...
      if (
        props.animate_scrollfix &&
        window.scrollY > 300 &&
        pos.top < 0 &&
        !document.querySelector(".noscrollfix:hover")
      ) {
        return true;
      } else {
        return false;
    ...
    Animation.prototype.slideUp = function (elem, remove_func, props) {
      ...
      setTimeout(function () {
        ...
        elem.style.marginTop =
          0 -
          parseInt(cstyle.borderTopWidth) -
          parseInt(cstyle.borderBottomWidth) +
          "px";
        elem.style.marginBottom = "0px";
        elem.style.paddingTop = "0px";
        elem.style.paddingBottom = "0px";
        ...
        (function (_this) {
          return function () {
            ...
            clone.style.marginLeft =
              parseInt(cstyle.marginLeft) + elem.offsetLeft - cloneleft + "px";
            elem.parentNode.insertBefore(clone, elem);
...
(function () {
  ...
  Editable = (function (superClass) {
    ...
    Editable.prototype.render = function (body) {
      if (this.editing) {
        return h(
          "div.editable.editing",
          {
            exitAnimation: Animation.slideUp,
          },
          this.field_edit.render(body),
          h(
            "div.editablebuttons",
            h(
              "a.link",
            ...
            this.handleDelete
              ? h(
                  "a.button.button-submit.button-small.button-outline",
                  {
                    href: "#Delete",
              ...
              : void 0,
            h(
              "a.button.button-submit.button-small",
              {
                href: "#Save",
...
(function () {
  ...
  ImagePreview = (function (superClass) {
    ...
    ImagePreview.prototype.calcSize = function (
      source_width,
      source_height,
      target_width,
      target_height
    ...
    ImagePreview.prototype.getPreviewUri = function (
      target_width,
      target_height
    ) {
      var b,
      ...
      (ref = this.preview_data.split(",")),
        ...
        (colors = ref[2]),
        (pixels = ref[3]);
      (ref1 = this.getSize(target_width, target_height)),
        (width = ref1[0]),
        (height = ref1[1]);
...
(function () {
  ...
  document.body.addEventListener("mouseup", function (e) {
    ...
    if (
      e.target !== window.visible_menu.node.parentNode &&
...
(function () {
  ...
  Overlay = (function (superClass) {
    ...
    Overlay.prototype.zoomImageTag = function (
      tag,
      target_width,
      target_height
    ) {
    ...
    Overlay.prototype.handleClick = function () {
      ...
      this.image_transform = "scale(" + ratio + ") ";
      this.image_margin_left = Math.floor(
        (this.original_pos.width - this.image_width) / 2
      );
      this.image_margin_top = Math.floor(
        (this.original_pos.height - this.image_height) / 2
      );
      this.log(
        this.image_margin_top,
        this.image_margin_left,
        this.image_width,
        this.image_height
      );
      this.visible = false;
...
(function () {
  ...
  Text = (function () {
    ...
    Text.prototype.toColor = function (text, saturation, lightness) {
      ...
      if (
        ((ref1 = Page.server_info) != null
          ? (ref2 = ref1.user_settings) != null
            ? ref2.theme
            : void 0
          : void 0) === "dark"
      ) {
    ...
    Text.prototype.renderLinks = function (text) {
      ...
      text = text.replace(/(https?:\/\/[^\s)]+)/g, function (match) {
        return (
          '<a href="' + match.replace(/&amp;/g, "&") + '">' + match + "</a>"
        );
      });
      text = text.replace(/\n/g, "<br>");
      text = text.replace(
    ...
    Text.prototype.fixHtmlLinks = function (text) {
      text = text.replace(
        /href="http:\/\/(127.0.0.1|localhost):43110\/(Me.mojoNetwork.bit|)\/\?/gi,
        'href="?'
      );
      if (window.is_proxy) {
        text = text.replace(
          /href="http:\/\/(127.0.0.1|localhost):43110/gi,
          'href="http://mojo'
        );
        text = text.replace(/http:\/\/mojo\/([^\/]+\.bit)/, "http://$1");
        text = text.replace(
          /href="\/([A-Za-z0-9]{26,35})/g,
          'href="http://mojo/$1'
        );
      } else {
        text = text.replace(
      ...
      text = text.replace(
        /href="\?/g,
        'onclick="return Page.handleLinkClick(window.event)" href="?'
      );
      return text;
    };
  ...
  Uploadable = (function (superClass) {
      ...
      image.onload = (function (_this) {
        return function () {
          ...
          if (_this.preverse_ratio) {
            (ref = _this.image_preview.calcSize(
              image.width,
              image.height,
              width,
              height
          ...
          if (_this.try_png) {
            ...
            image_base64uri =
              "data:image/png;base64," + btoa(optimizer.convert());
            if (image_base64uri.length > _this.png_limit) {
              _this.log(
                "PNG too large (" +
                  image_base64uri.length +
                  " bytes), convert to jpg instead"
              );
      ...
      image.onerror = (function (_this) {
        return function (e) {
          ...
          Page.cmd("wrapperNotification", [
            "error",
            "Invalid image, only jpg format supported",
          ]);
          return cb(null);
        };
      })(this);
      ...
      input.onchange = (function (_this) {
        return function (e) {
          ...
          return _this.resizeImage(
            ...
            _this.resize_width,
            _this.resize_height,
            function (image_base64uri, width, height) {
    ...
    Uploadable.prototype.getPixelData = function (data) {
      ...
      for (i = j = 0, ref = data.length - 1; j <= ref; i = j += 4) {
        ...
        g = Math.round(g / 17);
        b = Math.round(b / 17);
        hex = Number(0x1000 + r * 0x100 + g * 0x10 + b)
          .toString(16)
          .substring(1);
        if (i === 0) {
    ...
    Uploadable.prototype.getPreviewData = function (
      image_base64uri,
      target_width,
      target_height,
      cb
  ...
  ActivityList = (function (superClass) {
            ...
            return Page.cmd(
              ...
              function (subject_rows) {
                ...
                for (j = 0, len1 = subject_rows.length; j < len1; j++) {
                  ...
                  subject_row.auth_address = subject_row.directory.replace(
                    "data/users/",
                    ""
                  );
                ...
                for (l = 0, len3 = rows.length; l < len3; l++) {
                  ...
                  if (
                    !last_row ||
                    (row.auth_address ===
                      (last_row != null ? last_row.auth_address : void 0) &&
                      row.type ===
                        (last_row != null ? last_row.type : void 0) &&
                      ((ref = row.type) === "post_like" || ref === "follow"))
                  ) {
                    row_group.push(row);
                  } else {
    ...
    ActivityList.prototype.renderActivity = function (activity_group) {
      ...
      activity_user_link =
        ...
        activity.hub +
        "/" +
        activity.auth_address +
        "/" +
        activity.cert_user_id;
      subject_user_link =
        "?Profile/" +
        activity.subject.hub +
        "/" +
        activity.subject.auth_address +
        "/" +
        (activity.subject.cert_user_id || "");
      subject_post_link =
        "?Post/" +
        activity.subject.hub +
        "/" +
      ...
      if (activity.type === "post_like") {
        ...
        if (activity_group.length > 1) {
          ...
          for (i = 0, len = ref.length; i < len; i++) {
            ...
            subject_user_link =
              "?Profile/" +
              activity_more.subject.hub +
              "/" +
              activity_more.subject.auth_address +
              "/" +
              (activity_more.subject.cert_user_id || "");
            subject_post_link =
              "?Post/" +
              activity_more.subject.hub +
              "/" +
    ...
    ActivityList.prototype.render = function () {
      ...
      return h("div.activity-list", [
        ...
        h("div.items", [
          h("div.bg-line"),
          this.activities
            .slice(0, +(this.limit - 1) + 1 || 9e9)
            .map(this.renderActivity),
        ]),
        this.found > this.limit
          ? h(
              "a.more.small",
              {
                href: "#More",
...
(function () {
  ...
  AnonUser = (function (superClass) {
    ...
    AnonUser.prototype.updateInfo = function (cb) {
      ...
      return Page.on_local_storage.then(
        (function (_this) {
          return function () {
    ...
    AnonUser.prototype.like = function (site, post_uri, cb) {
      ...
      Page.cmd("wrapperNotification", [
        "info",
        "You need a profile for this feature",
      ]);
      return cb(true);
    };
    ...
    AnonUser.prototype.followUser = function (
      hub,
      auth_address,
      user_name,
      cb
  ...
  ContentCreateProfile = (function (superClass) {
    ...
    ContentCreateProfile.prototype.handleJoinClick = function (e) {
      ...
      if ((ref = Page.user) != null ? ref.hub : void 0) {
        ...
        return Page.cmd(
          "wrapperConfirm",
          [
            "You already have profile on hub <b>" +
              hub_name +
              "</b>,<br>are you sure you want to create a new one?",
            "Create new profile",
          ],
          (function (_this) {
            return function () {
    ...
    ContentCreateProfile.prototype.render = function () {
      ...
      return h("div#Content.center.content-signup", [
        ...
        h(
          "a.button.button-submit.button-certselect.certselect",
          {
            href: "#Select+user",
          ...
          [
            ...
            ((ref = Page.site_info) != null ? ref.cert_user_id : void 0)
              ? "As: " + Page.site_info.cert_user_id
              : "Select ID...",
          ]
        ),
        this.creation_status.length > 0
          ? h(
              "div.creation-status",
              {
                enterAnimation: Animation.slideDown,
          ...
          ? h(
              ...
              [
                this.hubs.length
                  ? h(
                      "div.hubselect.seeded",
                      {
                        enterAnimation: Animation.slideDown,
                        exitAnimation: Animation.slideUp,
                      },
                      [h("h2", "Seeded HUBs"), this.renderSeededHubs()]
                    )
                  : void 0,
                this.default_hubs.length
                  ? h(
                      "div.hubselect.default",
                      {
                        enterAnimation: Animation.slideDown,
                        exitAnimation: Animation.slideUp,
                      },
                      [h("h2", "Available HUBs"), this.renderDefaultHubs()]
                    )
                  : void 0,
                h(
                  "h5",
    ...
    ContentFeed.prototype.render = function () {
      ...
      if (this.need_update) {
        ...
        if (this.type === "followed") {
          ...
          if (Page.user.hub) {
            this.post_list.directories.push(
              "data/users/" + Page.user.auth_address
            );
          }
      ...
      return h("div#Content.center", [
        ...
        h("div.col-right.noscrollfix", [
          ...
          this.new_user_list.users.length > 0
            ? h("h2.sep.new", [
                "New users",
                h(
                  "a.link",
          ...
          this.suggested_user_list.users.length > 0
            ? h("h2.sep.suggested", ["Suggested users"])
            : void 0,
...
(function () {
  ...
  ContentProfile = (function (superClass) {
        ...
        h("div.col-left", [
          h("div.users", [
            h("div.user.card.profile", [
              ...
              h("div.cert_user_id", this.user.row.cert_user_id),
              h("div.intro-full", this.user.row.intro),
              h("div.follow-container", [
                h(
                  "a.button.button-follow-big",
                  {
                    href: "#",
                  ...
                  h("span.icon-follow", "+"),
                  this.user.isFollowed() ? "Unfollow" : "Follow"
                ),
              ]),
            ]),
          ]),
    ...
    ContentProfile.prototype.setUser = function (hub, auth_address) {
      ...
      if (
        !this.post_list ||
        this.post_list.directories[0] !== "data/users/" + this.auth_address
      ) {
        this.post_list = new PostList();
        this.activity_list = new ActivityList();
    ...
    ContentProfile.prototype.handleAvatarUpload = function (image_base64uri) {
      ...
      image_base64 =
        image_base64uri != null ? image_base64uri.replace(/.*?,/, "") : void 0;
      ...
      return Page.cmd(
        "fileWrite",
        [this.user.getPath() + "/avatar." + ext, image_base64],
        (function (_this) {
          return function (res) {
    ...
    ContentProfile.prototype.handleOptionalHelpClick = function () {
      if (Page.server_info.rev < 1700) {
        Page.cmd("wrapperNotification", [
          "info",
          "You need mojoNet version 0.5.0 use this feature",
        ]);
        return false;
      }
      this.user.hasHelp(
        (function (_this) {
          return function (optional_helping) {
            ...
            if (_this.optional_helping) {
              Page.cmd("OptionalHelpRemove", [
                "data/users/" + _this.user.auth_address,
                _this.user.hub,
              ]);
              _this.optional_helping = false;
            } else {
              Page.cmd("OptionalHelp", [
                "data/users/" + _this.user.auth_address,
                _this.user.row.user_name + "'s new files",
                _this.user.hub,
              ]);
    ...
    ContentProfile.prototype.render = function () {
      ...
      if (this.need_update) {
        this.log("Updating");
        this.need_update = false;
        this.post_list.filter_post_ids = this.filter_post_id
          ? [this.filter_post_id]
          : null;
        ...
        this.user.get(
          ...
          (function (_this) {
            return function (res) {
              ...
              if (res) {
                _this.owned =
                  _this.user.auth_address ===
                  ((ref3 = Page.user) != null ? ref3.auth_address : void 0);
                if (_this.owned && !_this.editable_intro) {
                  _this.editable_intro = new Editable(
                    "div",
                    _this.handleIntroSave
                  );
                  _this.editable_intro.render_function = Text.renderMarked;
                  _this.editable_user_name = new Editable(
                    "span",
                    _this.handleUserNameSave
                  );
                  _this.uploadable_avatar = new Uploadable(
                    _this.handleAvatarUpload
                  );
      ...
      if (
        ...
        if (this.loaded) {
          return h("div#Content.center." + this.auth_address, [
            h("div.user-notfound", "User not found or muted"),
          ]);
        } else {
          return h("div#Content.center." + this.auth_address, []);
        }
          ...
          [
            h("div.users", [
              h(
                ...
                [
                  this.owned
                    ? this.uploadable_avatar.render(this.user.renderAvatar)
                    : this.user.renderAvatar(),
                  h(
                    "span.name.link",
                    {
                      style:
                        "color: " + Text.toColor(this.user.row.auth_address),
                    },
                    this.owned
                      ? this.editable_user_name.render(this.user.row.user_name)
                      : h(
                          "a",
                          {
                            href: this.user.getLink(),
                            style:
                              "color: " +
                              Text.toColor(this.user.row.auth_address),
                            onclick: Page.handleLinkClick,
                          },
                          this.user.row.user_name
                        )
                  ...
                  this.owned
                    ? h(
                        "div.intro-full",
                        this.editable_intro.render(this.user.row.intro)
                      )
                    : h("div.intro-full", {
            ...
            h(
              ...
              "Mute " + this.user.row.cert_user_id
            ),
            this.activity_list.render(),
  ...
  ContentUsers = (function (superClass) {
    ...
    ContentUsers.prototype.render = function () {
      ...
      return h("div#Content.center", [
        ...
        !this.search
          ? [
              this.user_list_suggested.users.length > 0
                ? h("h2.suggested", "Suggested users")
                : void 0,
              h("div.users.cards.suggested", [
                this.user_list_suggested.render("card"),
              ]),
              this.user_list_suggested.users.length ===
              this.user_list_suggested.limit
                ? h(
                    "a.more.suggested",
                    {
                      href: "#",
                ...
                : this.user_list_suggested.users.length > 0 &&
                  this.user_list_suggested.loading
                ? h(
                    "a.more.suggested",
                    {
                      href: "#",
                ...
                : void 0,
              this.user_list_active.users.length > 0
                ? h("h2.active", "Most active")
                : void 0,
              h("div.users.cards.active", [
                this.user_list_active.render("card"),
              ]),
              this.user_list_active.users.length === this.user_list_active.limit
                ? h(
                    "a.more.active",
                    {
                      href: "#",
                ...
                : void 0,
              this.user_list_recent.users.length > 0
                ? h("h2.recent", "New users in mojome")
                : void 0,
            ]
          : void 0,
        h("div.users.cards.recent", [this.user_list_recent.render("card")]),
        this.user_list_recent.users.length === this.user_list_recent.limit
          ? h(
              "a.more.recent",
              {
                href: "#",
          ...
          : void 0,
        this.user_list_recent.users.length
          ? h(
              "h5",
              {
                style: "text-align: center",
              },
              "Total: " + this.num_users_total + " registered users"
            )
          : void 0,
      ]);
    };
...
(function () {
  ...
  Head = (function (superClass) {
    ...
    function Head() {
      ...
      this.handleFollowMenuItemClick = bind(
        this.handleFollowMenuItemClick,
        this
      );
      this.menu = new Menu();
      this.follows = [];
    ...
    Head.prototype.handleSelectUserClick = function () {
      if (
        indexOf.call(Page.site_info.settings.permissions, "Merger:mojome") < 0
      ) {
        Page.cmd(
      ...
      Page.cmd(
        ...
        (function (_this) {
          return function (follows) {
            ...
            _this.menu.items.push([
              "Follow comments on your posts",
              function (item) {
                return _this.handleFollowMenuItemClick(
            ...
            _this.menu.items.push([
              'Hide "Hello mojome!" messages',
              function (item) {
                Page.local_storage.settings.hide_hello_mojome =
                  !Page.local_storage.settings.hide_hello_mojome;
                item[2] = Page.local_storage.settings.hide_hello_mojome;
                Page.projector.scheduleRender();
    ...
    Head.prototype.saveFollows = function () {
      ...
      if (this.follows["Mentions"]) {
        out["Mentions"] = [
          "SELECT 'mention' AS type, comment.date_added AS date_added, 'a comment' AS title, '@' || user_name || ': ' || comment.body AS body, '?Post/' || json.site || '/' || REPLACE(post_uri, '_', '/') AS url FROM comment LEFT JOIN json USING (json_id) WHERE comment.body LIKE '%@" +
            Page.user.row.user_name +
            "%' UNION SELECT 'mention' AS type, post.date_added AS date_added, 'In ' || json.user_name || \"'s post\" AS title, '@' || json.user_name || ': ' || post.body AS body, '?Post/' || json.site || '/' || REPLACE(json.directory, 'data/users/', '') || '/' || post_id AS url FROM post LEFT JOIN json USING (json_id) WHERE post.body LIKE '%@" +
            Page.user.row.user_name +
            "%'",
          [""],
        ];
      ...
      if (this.follows["Comments on your posts"]) {
        out["Comments on your posts"] = [
          "SELECT 'comment' AS type, comment.date_added AS date_added, 'Your post' AS title, '@' || json.user_name || ': ' || comment.body AS body, '?Post/' || site || '/' || REPLACE(post_uri, '_', '/') AS url FROM comment LEFT JOIN json USING (json_id) WHERE post_uri LIKE '" +
            Page.user.auth_address +
            "%'",
          [""],
        ];
      }
      if (this.follows["New followers"]) {
        out["New followers"] = [
          "SELECT 'follow' AS type, follow.date_added AS date_added, json.user_name || ' started following you' AS title, '' AS body, '?Profile/' || json.hub || REPLACE(json.directory, 'data/users', '') AS url FROM follow LEFT JOIN json USING(json_id) WHERE auth_address = '" +
            Page.user.auth_address +
    ...
    Head.prototype.render = function () {
      ...
      return h("div.head.center", [
        ...
        ((ref = Page.user) != null ? ref.hub : void 0)
          ...
          : !((ref1 = Page.user) != null ? ref1.hub : void 0) &&
            ((ref2 = Page.site_info) != null ? ref2.cert_user_id : void 0)
          ...
          : !((ref3 = Page.user) != null ? ref3.hub : void 0) && Page.site_info
          ? h("div.right.unknown", [
              h(
                "div.user",
                h(
...
(function () {
  ...
  Post = (function (superClass) {
    ...
    Post.prototype.setRow = function (row) {
      ...
      this.user.row = row;
      this.owned =
        this.user.auth_address ===
        ((ref = Page.user) != null ? ref.auth_address : void 0);
      if (this.owned) {
        this.editable_body = new Editable(
          "div.body",
          this.handlePostSave,
        ...
        (function (_this) {
          return function (data) {
            ...
            if (
              ...
              return Page.cmd(
                "fileDelete",
                _this.user.getPath() + "/" + _this.row.post_id + ".jpg",
                function () {
                  return Page.user.save(data, Page.user.hub, function (res) {
                    return cb(res);
                  });
    ...
    Post.prototype.handleCommentSubmit = function () {
      ...
      (ref = this.row.key.split("-")), (site = ref[0]), (post_uri = ref[1]);
      return Page.user.comment(
        site,
        post_uri,
        this.field_comment.attrs.value,
        (function (_this) {
          return function (res) {
    ...
    Post.prototype.getEditableComment = function (comment_uri) {
      ...
      if (!this.editable_comments[comment_uri]) {
        ...
        this.editable_comments[comment_uri] = new Editable(
          "div.body",
          handleCommentSave,
          handleCommentDelete
        );
    ...
    Post.prototype.handleSettingsClick = function () {
      this.css_style =
        "z-index: " + this.row.date_added + "; position: relative";
      Page.cmd(
        "feedListFollow",
        [],
        (function (_this) {
          return function (follows) {
            ...
            followed =
              follows["Post follow"] &&
              ((ref = _this.getPostUri()),
              indexOf.call(follows["Post follow"][1], ref) >= 0);
            _this.menu.items = [];
            _this.menu.items.push([
              "Follow in newsfeed",
              function () {
        ...
        [
          this.commenting
            ? h(
                ...
                this.field_comment.render()
              )
            : void 0,
          (ref = this.row.comments) != null
            ? ref.slice(0, +(comment_limit - 1) + 1 || 9e9).map(
                (function (_this) {
                  return function (comment) {
                    ...
                    owned =
                      user_address ===
                      ((ref1 = Page.user) != null ? ref1.auth_address : void 0);
                    user_link =
                      "?Profile/" +
                      comment.hub +
                      "/" +
                      ...
                      [
                        ...
                        owned
                          ? _this
                              ...
                              .render(comment.body)
                          : ((ref2 = comment.body) != null
                              ? ref2.length
                              : void 0) > 5000
                          ? h("div.body.maxheight", {
            ...
            : void 0,
          ((ref1 = this.row.comments) != null ? ref1.length : void 0) >
          comment_limit
            ? h(
                "a.more",
                {
    ...
    Post.prototype.render = function () {
      ...
      return h(
        ...
        [
          ...
          this.owned
            ? this.editable_body.render(this.row.body)
            : h("div.body", {
                classes: {
                  maxheight:
                    !this.row.selected &&
                    ((ref1 = this.row.body) != null ? ref1.length : void 0) >
                      3000,
                },
          ...
          h("div.actions", [
            ...
            h(
              "a.like.link",
              {
                classes: {
                  active:
                    (ref2 = Page.user) != null ? ref2.likes[post_uri] : void 0,
              ...
              h("div.icon.icon-heart", {
                classes: {
                  active:
                    (ref3 = Page.user) != null ? ref3.likes[post_uri] : void 0,
                },
              }),
...
(function () {
  ...
  PostCreate = (function (superClass) {
    ...
    PostCreate.prototype.handleUpload = function (base64uri, width, height) {
      ...
      return this.upload.getPreviewData(
        base64uri,
        10,
        10,
        (function (_this) {
    ...
    PostCreate.prototype.handlePostSubmit = function () {
      ...
      Page.user.post(
        this.field_post.attrs.value,
        meta,
        (ref = this.image.base64uri) != null
          ? ref.replace(/.*base64,/, "")
          : void 0,
        (function (_this) {
          return function (res) {
    ...
    PostCreate.prototype.handleUploadClick = function () {
      if (Page.server_info.rev < 1700) {
        return Page.cmd("wrapperNotification", [
          "info",
          "You need mojoNet version 0.5.0 to upload images",
        ]);
      } else {
    ...
    PostCreate.prototype.render = function () {
      ...
      if (user === false) {
        ...
        return h(
          "div.post-create.post.empty.noprofile",
          h(
            "div.user",
            h("a.avatar", {
              href: "#",
          ...
          h(
            "div.select-user-container",
            h(
              "a.button.button-submit.select-user",
              {
                href: "?Create+profile",
                onclick: Page.handleLinkClick,
              },
        ...
        return h(
          "div.post-create.post.empty.nocert",
          h(
            "div.user",
            h("a.avatar", {
              href: "#",
          ...
          h(
            ...
            h(
              ...
              [h("div.icon.icon-profile"), "Select user to post new content"]
            )
          ),
          h("textarea", {
            disabled: true,
...
(function () {
  ...
  PostList = (function (superClass) {
    ...
    PostList.prototype.queryComments = function (post_uris, cb) {
      var query;
      query =
        "SELECT post_uri, comment.body, comment.date_added, comment.comment_id, json.cert_auth_type, json.cert_user_id, json.user_name, json.hub, json.directory, json.site FROM comment LEFT JOIN json USING (json_id) WHERE ? AND date_added < " +
        (Time.timestamp() + 120) +
        " ORDER BY date_added DESC";
      return Page.cmd(
        "dbQuery",
    ...
    PostList.prototype.queryLikes = function (post_uris, cb) {
      var query;
      query =
        "SELECT post_uri, COUNT(*) AS likes FROM post_like WHERE ? GROUP BY post_uri";
      return Page.cmd(
        "dbQuery",
        [
          query,
    ...
    PostList.prototype.update = function () {
      ...
      if (this.directories === "all") {
        where =
          "WHERE post_id IS NOT NULL AND post.date_added < " +
          (Time.timestamp() + 120) +
          " ";
      } else {
        where =
          "WHERE directory IN " +
          Text.sqlIn(this.directories) +
          " AND post_id IS NOT NULL AND post.date_added < " +
          (Time.timestamp() + 120) +
          " ";
      }
      ...
      if (Page.local_storage.settings.hide_hello_mojome) {
        where += "AND post_id > 1 ";
      }
      query =
        "SELECT * FROM post LEFT JOIN json ON (post.json_id = json.json_id) " +
        where +
          ...
          return function (rows) {
            ...
            for (j = 0, len = rows.length; j < len; j++) {
              ...
              row["key"] =
                row["site"] +
                "-" +
                row["directory"].replace("data/users/", "") +
                "_" +
                row["post_id"];
              row["post_uri"] =
                row["directory"].replace("data/users/", "") +
            ...
            _this.queryComments(post_uris, function (comment_rows) {
              ...
              for (k = 0, len1 = comment_rows.length; k < len1; k++) {
                ...
                if (
                  comment_db[
                    (name = comment_row.site + "/" + comment_row.post_uri)
                  ] == null
                ) {
                  comment_db[name] = [];
                }
                comment_db[comment_row.site + "/" + comment_row.post_uri].push(
                  comment_row
                );
              }
              for (l = 0, len2 = rows.length; l < len2; l++) {
                ...
                if (
                  ((ref = _this.filter_post_ids) != null
                    ? ref.length
                    : void 0) === 1 &&
                  row.post_id === parseInt(_this.filter_post_ids[0])
                ) {
                  row.selected = true;
                }
              }
    ...
    PostList.prototype.render = function () {
      ...
      return [
        h(
          "div.post-list",
          this.posts.slice(0, +this.limit + 1 || 9e9).map(
            (function (_this) {
...
(function () {
  ...
  PostMeta = (function (superClass) {
    ...
    PostMeta.prototype.afterCreateImage = function (tag) {
      return Page.scrollwatcher.add(
        tag,
        (function (_this) {
          return function () {
            var e;
            try {
              _this.image_preview.preview_uri =
                _this.image_preview.getPreviewUri();
              Page.cmd(
                "optionalFileInfo",
                _this.post.user.getPath() +
                  "/" +
                  _this.post.row.post_id +
                  ".jpg",
                function (res) {
    ...
    PostMeta.prototype.handleImageClick = function (e) {
      var image, ref;
      if (
        this.image_preview.load_fullsize ||
        ((ref = this.image_preview.optional_info) != null
          ? ref.is_downloaded
          : void 0)
      ) {
        Page.overlay.zoomImageTag(
          e.currentTarget,
          this.image_preview.width,
          this.image_preview.height
        );
      } else {
        ...
        image = new Image();
        image.src =
          this.post.user.getPath() + "/" + this.post.row.post_id + ".jpg";
        image.onload = (function (_this) {
          return function () {
    ...
    PostMeta.prototype.handleOptionalHelpClick = function () {
      this.post.user.hasHelp(
        (function (_this) {
          return function (optional_helping) {
            _this.optional_helping = optional_helping;
            if (_this.optional_helping) {
              Page.cmd("OptionalHelpRemove", [
                "data/users/" + _this.post.user.auth_address,
                _this.post.user.hub,
              ]);
              _this.optional_helping = false;
            } else {
              Page.cmd("OptionalHelp", [
                "data/users/" + _this.post.user.auth_address,
                _this.post.row.user_name + "'s new images",
                _this.post.user.hub,
              ]);
              _this.optional_helping = true;
            }
        ...
        (function (_this) {
          return function (helping) {
            ...
            _this.menu_image.items.push([
              "Help distribute this user's new images",
              _this.handleOptionalHelpClick,
              function () {
            ...
            _this.menu_image.items.push(["---"]);
            if (
              (ref = _this.image_preview.optional_info) != null
                ? ref.is_downloaded
                : void 0
            ) {
              _this.menu_image.items.push([
                "Delete image",
                _this.handleImageDeleteClick,
              ]);
            } else {
              _this.menu_image.items.push([
                "Show image",
    ...
    PostMeta.prototype.render = function () {
      ...
      if (this.meta.img) {
        ...
        (ref = this.image_preview.getSize(530, 600)),
          (width = ref[0]),
          (height = ref[1]);
        if ((ref1 = this.image_preview) != null ? ref1.preview_uri : void 0) {
          style_preview =
            "background-image: url(" + this.image_preview.preview_uri + ")";
        } else {
          style_preview = "";
        }
        if (
          this.image_preview.load_fullsize ||
          ((ref2 = this.image_preview.optional_info) != null
            ? ref2.is_downloaded
            : void 0)
        ) {
          style_fullsize =
            "background-image: url(" +
            this.post.user.getPath() +
            "/" +
        ...
        return h(
          "div.img.preview",
          {
            ...
            classes: {
              downloaded:
                (ref3 = this.image_preview.optional_info) != null
                  ? ref3.is_downloaded
                  : void 0,
              hasinfo:
                ((ref4 = this.image_preview.optional_info) != null
                  ? ref4.peer
                  : void 0) !== null,
          ...
          Page.server_info.rev < 1700
            ? h("small.oldversion", "You need mojoNet 0.5.0 to view this image")
            : void 0,
          ((ref5 = this.image_preview) != null ? ref5.optional_info : void 0)
            ? h(
                "a.show",
                {
                  href: "#",
            ...
            : void 0,
          ((ref6 = this.image_preview) != null ? ref6.optional_info : void 0)
            ? h(
                "a.details",
                {
                  href: "#Settings",
                ...
                [
                  h(
                    "div.size",
                    Text.formatSize(
                      (ref7 = this.image_preview.optional_info) != null
                        ? ref7.size
                        : void 0
                    )
                  ),
                  h("div.peers.icon-profile"),
                  (ref8 = this.image_preview.optional_info) != null
                    ? ref8.peer
                    : void 0,
                  h("a.image-settings", "\u22EE"),
                  this.menu_image
                    ? this.menu_image.render(".menu-right")
                    : void 0,
                ]
              )
            : void 0
  ...
  User = (function (superClass) {
    ...
    User.prototype.get = function (site, auth_address, cb) {
      ...
      return Page.cmd(
        "dbQuery",
        [
          "SELECT * FROM json WHERE site = :site AND directory = :directory LIMIT 1",
          params,
        ],
        (function (_this) {
          return function (res) {
    ...
    User.prototype.updateInfo = function (cb) {
      ...
      Page.cmd(
        "dbQuery",
        ["SELECT * FROM follow WHERE json_id = " + this.row.json_id],
        (function (_this) {
          return function (res) {
            var j, len, row;
      ...
      Page.cmd(
        "dbQuery",
        [
          "SELECT post_like.* FROM json LEFT JOIN post_like USING (json_id) WHERE directory = 'data/users/" +
            this.auth_address +
      ...
      return Promise.join(p_followed_users, p_likes).then(
        (function (_this) {
    ...
    User.prototype.getPath = function (site) {
      ...
      if (site === Page.userdb) {
        return "merged-mojome/" + site + "/data/userdb/" + this.auth_address;
      } else {
        return "merged-mojome/" + site + "/data/users/" + this.auth_address;
      }
    };
    ...
    User.prototype.getData = function (site, cb) {
      return Page.cmd(
        "fileGet",
        [this.getPath(site) + "/data.json", false],
        (function (_this) {
          return function (data) {
            var ref;
    ...
    User.prototype.renderAvatar = function (attrs) {
      ...
      if (
        this.isSeeding() &&
        (this.row.avatar === "png" || this.row.avatar === "jpg")
      ) {
        attrs.style = "background-image: url('" + this.getAvatarLink() + "')";
      } else {
        attrs.style =
          "background: linear-gradient(" +
          Text.toColor(this.auth_address) +
          "," +
          Text.toColor(this.auth_address.slice(-5)) +
          ")";
      }
    ...
    User.prototype.save = function (data, site, cb) {
      ...
      return Page.cmd(
        "fileWrite",
        [this.getPath(site) + "/data.json", Text.fileEncode(data)],
        (function (_this) {
    ...
    User.prototype.saveUserdb = function (data, cb) {
      ...
      if (cert_provider !== "mojoid.bit" && cert_provider !== "mojoverse.bit") {
        this.log(
          "Cert provider " + cert_provider + " not supported by userdb!"
        );
        cb(false);
        return false;
      }
      return Page.cmd(
        "fileGet",
        [this.getPath(Page.userdb) + "/content.json", false],
        (function (_this) {
          return function (userdb_data) {
            ...
            if (changed) {
              return Page.cmd(
                "fileWrite",
                [
                  _this.getPath(Page.userdb) + "/content.json",
                  Text.fileEncode(userdb_data),
                ],
                function (res_write) {
                  return Page.cmd(
                    "sitePublish",
    ...
    User.prototype.checkContentJson = function (cb) {
      ...
      return Page.cmd(
        "fileGet",
        [this.getPath(this.hub) + "/content.json", false],
        (function (_this) {
          return function (res) {
            var content_json;
            ...
            return Page.cmd(
              "fileWrite",
              [
                _this.getPath(_this.hub) + "/content.json",
                Text.fileEncode(content_json),
              ],
              function (res_write) {
                return cb(res_write);
              }
      ...
      return this.checkContentJson(
        (function (_this) {
          return function () {
            return Page.cmd(
              "fileWrite",
              [_this.getPath(_this.hub) + "/" + file_name, content_base64],
              function (res_write) {
    ...
    User.prototype.handleMuteClick = function (e) {
      ...
      Page.cmd("muteAdd", [
        this.auth_address,
        this.row.cert_user_id,
        "Muted from [page](http://127.0.0.1:43110/" +
          Page.address +
          "/?" +
          Page.history_state.url +
          ")",
      ]);
      return false;
    };
      ...
      return h(
        ...
        [
          ...
          h("div.nameline", [
            ...
            type === "card"
              ? h("span.added", Time.since(this.row.date_added))
              : void 0,
          ]),
...
(function () {
  ...
  UserList = (function (superClass) {
    ...
    UserList.prototype.update = function () {
      var followed_user_addresses,
        followed_user_directories,
        key,
        params,
        query,
        search_where,
      ...
      if (this.search) {
        search_where =
          "AND (json.user_name LIKE :search_like OR user.user_name LIKE :search_like OR json.cert_user_id LIKE :search_like)";
      ...
      if (this.followed_by) {
        ...
        query =
          ...
          Text.sqlIn(followed_user_directories) +
          " AND\n auth_address NOT IN " +
          Text.sqlIn(followed_user_addresses) +
          " AND\n auth_address != '" +
          Page.user.auth_address +
          "' AND\n date_added < " +
          (Time.timestamp() + 120) +
          ...
          return function (rows) {
            ...
            for (i = 0, len = rows.length; i < len; i++) {
              ...
              if (row.json_cert_user_id) {
                ...
                row.auth_address = row.json_directory
                  .replace("data/userdb/", "")
                  .replace("data/users/", "");
              }
              if (!row.auth_address) {
    ...
    UserList.prototype.render = function (type) {
      ...
      return h(
        "div.UserList.users" + type + "." + this.type,
        {
          afterCreate: Animation.show,
        },
        this.users.map(
...
(function () {
  ...
  mojome = (function (superClass) {
    extend(mojome, superClass);
    ...
    function mojome() {
      ...
      return mojome.__super__.constructor.apply(this, arguments);
    }

    mojome.prototype.init = function () {
      this.params = {};
      this.merged_sites = {};
      this.site_info = null;
      ...
      return this.on_site_info.then(
        (function (_this) {
          return function () {
            if (
              indexOf.call(
                _this.site_info.settings.permissions,
                "Merger:mojome"
              ) < 0
            ) {
              return _this.cmd(
    ...
    mojome.prototype.createProjector = function () {
      var url;
    ...
    mojome.prototype.renderContent = function () {
      if (this.site_info) {
    ...
    mojome.prototype.route = function (query) {
      var changed, content;
      ...
      if (this.params.urls[0] === "Create+profile") {
        ...
        this.content_profile
          .setUser(this.params.urls[1], this.params.urls[2])
          .filter(null);
      } else if (this.params.urls[0] === "Post") {
        content = this.content_profile;
        changed =
          this.content_profile.auth_address !== this.params.urls[2] ||
          this.content_profile.filter_post_id !== this.params.urls[3];
        this.content_profile
          .setUser(this.params.urls[1], this.params.urls[2])
          .filter(this.params.urls[3]);
      } else {
      ...
      if (content && (this.content !== content || changed)) {
        ...
        return this.on_user_info.then(
          (function (_this) {
            return function () {
              return _this.projector.replace(
                $("#Content"),
    ...
    mojome.prototype.setUrl = function (url, mode) {
      if (mode == null) {
        mode = "push";
      }
      url = url.replace(/.*?\?/, "");
    ...
    mojome.prototype.handleLinkClick = function (e) {
      if (e.which === 2) {
        return true;
      } else {
    ...
    mojome.prototype.createUrl = function (key, val) {
      var params, vals;
    ...
    mojome.prototype.loadLocalStorage = function () {
      return this.on_site_info.then(
        (function (_this) {
          return function () {
    ...
    mojome.prototype.saveLocalStorage = function (cb) {
      if (cb == null) {
        cb = null;
      }
    ...
    mojome.prototype.onOpenWebsocket = function (e) {
      this.updateSiteInfo();
      return this.updateServerInfo();
    };

    mojome.prototype.updateSiteInfo = function (cb) {
      var on_site_info;
      if (cb == null) {
        cb = null;
      }
          ...
          return function (merged_sites) {
            ...
            return on_site_info.then(function () {
              if (
                ...
                !_this.merged_sites[_this.userdb]
              ) {
    ...
    mojome.prototype.updateServerInfo = function () {
      return this.cmd(
        "serverInfo",
        {},
        (function (_this) {
    ...
    mojome.prototype.needSite = function (address, cb) {
    ...
    mojome.prototype.checkUser = function (cb) {
      if (cb == null) {
        cb = null;
      }
              ...
              _this.queryUserdb(_this.site_info.auth_address, function (user) {
                if (user) {
                  if (!_this.merged_sites[user.hub]) {
                    _this.log(
                      "Profile not seeded, but found in the userdb",
                      user
                    );
    ...
    mojome.prototype.queryUserdb = function (auth_address, cb) {
      var query;
      query =
    ...
    mojome.prototype.onRequest = function (cmd, params) {
      if (cmd === "setSiteInfo") {
    ...
    mojome.prototype.setSiteInfo = function (site_info) {
      ...
      if (site_info.address === this.address) {
        ...
        this.site_info = site_info;
        if (
          ((ref = site_info.event) != null ? ref[0] : void 0) === "cert_changed"
        ) {
          this.checkUser(
            (function (_this) {
              return function (found) {
      ...
      if (
        ...
        if (
          file_name.indexOf(site_info.auth_address) !== -1 &&
          ((ref2 = Page.user) != null ? ref2.auth_address : void 0) !==
            site_info.auth_address
        ) {
          ...
          !this.merged_sites[site_info.address] &&
          site_info.address !== this.address
        ) {
          ...
          !file_name.endsWith("content.json") ||
          file_name.indexOf(this.userdb) !== -1
        ) {
    ...
    mojome.prototype.setServerInfo = function (server_info) {
      ...
      if (this.server_info.rev < 1400) {
        this.cmd("wrapperNotification", [
          "error",
          "This site requries mojoNet 0.4.0+<br>Please delete the site from your current client, update it, then add again!",
        ]);
      }
      return this.projector.scheduleRender();
    };

    mojome.prototype.returnFalse = function () {
      return false;
    };
