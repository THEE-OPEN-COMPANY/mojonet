        ...
        hub.type === "available" ? h("a.button.button-join", {
          ...
          hub.users.map((function(_this) {
            return function(user) {
              ...
              avatar = "merged-mojome/" + hub.address + "/" + user.directory + "/avatar." + user.avatar;
              rendered += 1;
              return h("a.avatar", {
                key: user.user_name,
      ...
      return h("div#Content.center", [
        h("input.text.big.search", {
          ...
          this.user_list_suggested.users.length > 0 ? h("h2.suggested", "Suggested users") : void 0, h("div.users.cards.suggested", [this.user_list_suggested.render("card")]), this.user_list_suggested.users.length === this.user_list_suggested.limit ? h("a.more.suggested", {
            ...
            href: "#",
            onclick: this.handleActiveMoreClick
          }, "Loading...") : void 0, this.user_list_recent.users.length > 0 ? h("h2.recent", "New users in mojome") : void 0
...
(function() {
  ...
  Head = (function(superClass) {
    ...
    Head.prototype.handleSelectUserClick = function() {
      if (indexOf.call(Page.site_info.settings.permissions, "Merger:mojome") < 0) {
        Page.cmd("wrapperPermissionAdd", "Merger:mojome", (function(_this) {
          return function() {
    ...
    Head.prototype.handleMenuClick = function() {
      ...
      Page.cmd("feedListFollow", [], (function(_this) {
        return function(follows) {
          ...
          _this.menu.items.push([
            "Hide \"Hello mojome!\" messages", (function(item) {
              Page.local_storage.settings.hide_hello_mojome = !Page.local_storage.settings.hide_hello_mojome;
...
(function() {
  ...
  User = (function(superClass) {
    ...
    User.prototype.getAvatarLink = function() {
      ...
      return "merged-mojome/" + this.hub + "/data/users/" + this.auth_address + "/avatar." + this.row.avatar + cache_invalidation;
    };
  ...
  mojome = (function(superClass) {
    ...
    mojome.prototype.init = function() {
      ...
      return this.on_site_info.then((function(_this) {
        return function() {
          if (indexOf.call(_this.site_info.settings.permissions, "Merger:mojome") < 0) {
            return _this.cmd("wrapperPermissionAdd", "Merger:mojome", function() {
      ...
      this.cmd("mergerSiteList", {}, (function(_this) {
        return function(merged_sites) {
          ...
          return on_site_info.then(function() {
            if (indexOf.call(_this.site_info.settings.permissions, "Merger:mojome") >= 0 && !_this.merged_sites[_this.userdb]) {
