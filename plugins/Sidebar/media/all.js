...
(function () {
  ...
  Console = (function (superClass) {
    ...
    function Console(sidebar) {
      ...
      this.tab_active = "";
      handleMessageWebsocket_original =
        this.sidebar.wrapper.handleMessageWebsocket;
      this.sidebar.wrapper.handleMessageWebsocket = (function (_this) {
        return function (message) {
          if (
            message.cmd === "logLineAdd" &&
            message.params.stream_id === _this.stream_id
          ) {
      ...
      $(window).on(
        ...
        (function (_this) {
          return function () {
            if (window.top.location.hash.startsWith("#MojoNet:Console")) {
              return _this.open();
            }
          };
        })(this)
    ...
    Console.prototype.createHtmltag = function () {
      ...
      if (!this.container) {
        ...
        this.container.on(
          "mousedown touchend touchcancel",
          (function (_this) {
            return function (e) {
    ...
    Console.prototype.checkTextIsBottom = function () {
      return (this.text.is_bottom =
        Math.round(this.text_elem.scrollTop + this.text_elem.clientHeight) >=
        this.text_elem.scrollHeight - 15);
    };
    ...
    Console.prototype.formatLine = function (line) {
      ...
      level =
        "<span style='color: " +
        this.toColor(level, 100) +
        ";'>" +
        level +
        "</span>";
      module =
        "<span style='color: " +
        this.toColor(module, 60) +
        "; font-weight: bold;'>" +
        module +
        "</span>";
      text = text.replace(
        /(Site:[A-Za-z0-9\.]+)/g,
        "<span style='color: #AAAAFF'>$1</span>"
      );
    ...
    Console.prototype.addLines = function (lines, animate) {
      ...
      if (this.text.is_bottom && animate) {
        return this.text.stop().animate(
          {
            scrollTop:
              this.text_elem.scrollHeight - this.text_elem.clientHeight + 1,
          },
          600,
          "easeInOutCubic"
        );
    ...
    Console.prototype.loadConsoleText = function () {
      ...
      return this.sidebar.wrapper.ws.cmd(
        "consoleLogStream",
        {
          filter: this.filter,
        },
    ...
    Console.prototype.open = function () {
      ...
      this.sidebar.fixbutton_targety =
        this.sidebar.page_height - this.sidebar.fixbutton_inity - 50;
      return this.sidebar.stopDrag();
    };
    ...
    Console.prototype.stopDragY = function () {
      ...
      if (this.tag) {
        ...
        this.tag.css("transform", "translateY(" + targety + "px)").one(
          transitionEnd,
          (function (_this) {
            return function () {
    ...
    Console.prototype.handleTabClick = function (e) {
      ...
      window.top.location.hash = "#MojoNet:Console:" + elem.data("title");
      return false;
    };
...
(function () {
  ...
  Menu = (function () {
    ...
    Menu.prototype.show = function () {
      ...
      if (
        window.visible_menu &&
        window.visible_menu.button[0] === this.button[0]
      ) {
        ...
        if (
          this.elem.position().left + this.elem.width() + 20 >
          window.innerWidth
        ) {
    ...
    Menu.prototype.addItem = function (title, cb) {
      var item;
      item = $(".menu-item.template", this.elem)
        .clone()
  ...
  $("body").on("click", function (e) {
    if (
      window.visible_menu &&
      e.target !== window.visible_menu.button[0] &&
      $(e.target).parent()[0] !== window.visible_menu.elem[0]
    ) {
...
window.initScrollable = function () {
  ...
  function calculateScrollerHeight() {
    ...
    if (visibleRatio == 1) scroller.style.display = "none";
    else scroller.style.display = "block";
...
(function () {
  ...
  Sidebar = (function (superClass) {
    ...
    function Sidebar(wrapper1) {
      ...
      if (window.top.location.hash === "#MojoNet:OpenSidebar") {
        this.startDrag();
        this.moved("x");
    ...
    Sidebar.prototype.initFixbutton = function () {
      ...
      this.fixbutton.parent().on(
        "click touchend touchcancel",
        (function (_this) {
          return function (e) {
            if (+new Date() - _this.dragStarted < 100) {
              window.top.location = _this.fixbutton
                .find(".fixbutton-bg")
                .attr("href");
            }
    ...
    Sidebar.prototype.startDrag = function () {
      ...
      this.fixbutton.one(
        ...
        (function (_this) {
          return function (e) {
            ...
            moved_x = Math.abs(
              _this.fixbutton.offset().left - _this.fixbutton_initx
            );
            moved_y = Math.abs(
              _this.fixbutton.offset().top - _this.fixbutton_inity
            );
      ...
      return this.fixbutton.parents().one(
    ...
    Sidebar.prototype.waitMove = function (e) {
      ...
      moved_x = Math.abs(
        parseInt(this.fixbutton[0].style.left) - this.fixbutton_targetx
      );
      moved_y = Math.abs(
        parseInt(this.fixbutton[0].style.top) - this.fixbutton_targety
      );
      if (moved_x > 5 && +new Date() - this.dragStarted + moved_x > 50) {
        ...
        return this.fixbutton
          .parents()
          .off("mousemove touchmove", this.waitMove);
    ...
    Sidebar.prototype.setHtmlTag = function (res) {
        ...
        morphdom(
          ...
          '<div class="content">' + res + "</div>",
          {
            onBeforeMorphEl: function (from_el, to_el) {
              if (
                from_el.className === "globe" ||
                from_el.className.indexOf("noupdate") >= 0
              ) {
                return false;
              } else {
                return true;
      ...
      this.tag
        ...
        .on(
          ...
          (function (_this) {
            return function (e) {
              _this.wrapper.displayPrompt(
                "Enter your private key:",
                "password",
                "Save",
                "",
                function (privatekey) {
                  return _this.wrapper.ws.cmd(
      ...
      this.tag
        .find("#privatekey-forget")
        .off("click, touchend")
        .on(
          "click touchend",
          (function (_this) {
            return function (e) {
              _this.wrapper.displayConfirm(
                "Remove saved private key for this site?",
                "Forget",
                function (res) {
                  if (!res) {
                    return false;
      ...
      return this.tag
        ...
        .attr(
          "href",
          document.location.pathname.replace(/(\/.*?(\/|$)).*$/, "/list$1")
        );
    };
    ...
    Sidebar.prototype.animDrag = function (e) {
      ...
      if (overdrag > 0) {
        ...
        mousex =
          (mousex + (this.fixbutton_initx - this.width) * overdrag_percent) /
          (1 + overdrag_percent);
      }
      ...
      if (!this.move_lock || this.move_lock === "y") {
        ...
        if (this.console.tag) {
          this.console.tag[0].style.transform =
            "translateY(" + (0 - targety) + "px)";
        }
      }
      if (
        (!this.opened && targetx > this.width / 3) ||
        (this.opened && targetx > this.width * 0.9)
      ) {
        this.fixbutton_targetx = this.fixbutton_initx - this.width;
      } else {
        this.fixbutton_targetx = this.fixbutton_initx;
      ...
      if (
        (!this.console.opened && 0 - targety > this.page_height / 10) ||
        (this.console.opened && 0 - targety > this.page_height * 0.8)
      ) {
        return (this.fixbutton_targety =
          this.page_height - this.fixbutton_inity - 50);
      } else {
    ...
    Sidebar.prototype.stopDrag = function () {
      ...
      if (
        this.fixbutton_targetx !== this.fixbutton.offset().left ||
        this.fixbutton_targety !== this.fixbutton.offset().top
      ) {
        if (this.move_lock === "y") {
    ...
    Sidebar.prototype.stopDragX = function () {
      ...
      if (this.tag) {
        ...
        this.tag.css("transform", "translateX(-" + targetx + "px)").one(
          transitionEnd,
          (function (_this) {
            return function () {
              _this.tag.css("transition", "");
    ...
    Sidebar.prototype.sign = function (inner_path, privatekey) {
      ...
      return this.wrapper.ws.cmd(
        ...
        (function (_this) {
          return function (res) {
            if (res === "ok") {
              return _this.wrapper.displayProgress(
                "sign",
                inner_path + " signed!",
                100
              );
          ...
          return function (res) {
            if (res === "ok") {
              return _this.wrapper.notifications.add(
                "sign",
                "done",
                inner_path + " Signed and published!",
                5000
              );
            }
          };
    ...
    Sidebar.prototype.handleSiteDeleteClick = function () {
      ...
      return this.wrapper.displayConfirm(
        question,
        options,
        (function (_this) {
          return function (confirmed) {
            if (confirmed === 1) {
              ...
              return _this.wrapper.ws.cmd(
                "siteDelete",
                _this.wrapper.site_info.address,
                function () {
                  return (document.location = $(".fixbutton-bg").attr("href"));
                }
              );
            } else if (confirmed === 2) {
              return _this.wrapper.displayPrompt(
                "Blacklist this site",
                "text",
                ...
                function (reason) {
                  _this.tag.find("#button-delete").addClass("loading");
                  _this.wrapper.ws.cmd("siteblockAdd", [
                    _this.wrapper.site_info.address,
                    reason,
                  ]);
                  return _this.wrapper.ws.cmd(
    ...
    Sidebar.prototype.onOpened = function () {
      ...
      this.scrollable();
      this.tag
        .find("#checkbox-owned, #checkbox-autodownloadoptional")
        .off("click touchend")
        .on(
          "click touchend",
          (function (_this) {
      ...
      this.tag
        .find("#button-sitelimit")
        .off("click touchend")
        .on(
          "click touchend",
          (function (_this) {
            return function () {
              _this.wrapper.ws.cmd(
                "siteSetLimit",
                $("#input-sitelimit").val(),
                function (res) {
                  if (res === "ok") {
                    _this.wrapper.notifications.add(
                      "done-sitelimit",
                      "done",
      ...
      this.tag
        .find("#button-autodownload_bigfile_size_limit")
        .off("click touchend")
        .on(
          "click touchend",
          (function (_this) {
            return function () {
              _this.wrapper.ws.cmd(
                ...
                $("#input-autodownload_bigfile_size_limit").val(),
                function (res) {
                  if (res === "ok") {
                    _this.wrapper.notifications.add(
                      "done-bigfilelimit",
                      "done",
                      "Site bigfile auto download limit modified!",
                      5000
                    );
                  }
                  return _this.updateHtmlTag();
      ...
      this.tag
        .find("#button-autodownload_previous")
        .off("click touchend")
        .on(
          "click touchend",
          (function (_this) {
            return function () {
              _this.wrapper.ws.cmd(
                ...
                function () {
                  return _this.wrapper.notifications.add(
                    "done-download_optional",
                    "done",
                    "Optional files downloaded",
                    5000
                  );
                }
              );
              _this.wrapper.notifications.add(
                "start-download_optional",
                "info",
                "Optional files download started",
                5000
              );
              return false;
            };
          ...
          (function (_this) {
            return function () {
              ...
              return _this.wrapper.ws.cmd(
                "siteSetOwned",
                [owned],
                function (res_set_owned) {
                  _this.log("Owned", owned);
                  if (owned) {
                    return _this.wrapper.ws.cmd(
                      "siteRecoverPrivatekey",
                      [],
                      function (res_recover) {
                        if (res_recover === "ok") {
                          return _this.wrapper.notifications.add(
                            "recover",
                            "done",
                            "Private key recovered from master seed",
                            5000
                          );
                        } else {
                          return _this.log(
      ...
      this.tag
        .find("#checkbox-autodownloadoptional")
        .off("click touchend")
        .on(
          "click touchend",
          (function (_this) {
            return function () {
              return _this.wrapper.ws.cmd("siteSetAutodownloadoptional", [
                _this.tag.find("#checkbox-autodownloadoptional").is(":checked"),
              ]);
            };
          })(this)
        );
      this.tag
        .find("#button-identity")
        .off("click touchend")
        .on(
          "click touchend",
          (function (_this) {
          ...
          (function (_this) {
            return function () {
              _this.wrapper.ws.cmd("fileGet", "content.json", function (res) {
                ...
                return _this.wrapper.ws.cmd(
                  "fileWrite",
                  ["content.json", btoa(json_raw), true],
                  function (res) {
                    if (res !== "ok") {
                      return _this.wrapper.notifications.add(
                        "file-write",
      ...
      this.tag
        ...
        .on(
          ...
          (function (_this) {
            return function () {
              _this.wrapper.ws.cmd("serverShowdirectory", [
                "site",
                _this.wrapper.site_info.address,
              ]);
              return false;
            ...
            return function (e) {
              ...
              handler = function (e) {
                ...
                _this.wrapper.notifications.add(
                  "copy",
                  "done",
                  "Site address with peers copied to your clipboard",
                  5000
                );
      ...
      $(document).on(
        ...
        (function (_this) {
          return function () {
            ...
            return (ref1 = _this.tag) != null
              ? ref1.find(".contents + .flex").removeClass("sign-publish-flex")
              : void 0;
          };
        })(this)
      );
      this.tag
        .find(".contents-content")
        .off("click touchend")
        .on(
          "click touchend",
          (function (_this) {
          ...
          return function () {
            ...
            _this.wrapper.ws.cmd(
              ...
              function (rules) {
                var ref;
                if (
                  ((ref = _this.wrapper.site_info.auth_address),
                  indexOf.call(rules.signers, ref) >= 0)
                ) {
    ...
    Sidebar.prototype.onClosed = function () {
      ...
      $(document.body)
        .css("transition", "0.6s ease-in-out")
        .removeClass("body-sidebar")
        .on(
          transitionEnd,
          (function (_this) {
            return function (e) {
              if (
                ...
                !$(document.body).hasClass("body-sidebar") &&
                !$(document.body).hasClass("body-console")
              ) {
                $(document.body)
                  .css("height", "auto")
                  .css("perspective", "")
          ...
          return _this.wrapper.ws.cmd(
            ...
            function (globe_data) {
              ...
              if (_this.globe) {
                ...
                return (ref = _this.tag) != null
                  ? ref.find(".globe").removeClass("loading")
                  : void 0;
                ...
                return (ref2 = _this.tag) != null
                  ? ref2.find(".globe").removeClass("loading")
                  : void 0;
              }
            }
          );
      ...
      1: [
        ...
        if (!toEl.hasAttribute('value')) {
          ...
          function morphdom(fromNode, toNode, options) {
            ...
            var onBeforeMorphElChildren =
              options.onBeforeMorphElChildren || noop;
              ...
              outer: while (curToNodeChild) {
                ...
                while (curFromNodeChild) {
                  ...
                  if (!alreadyVisited) {
                    if (
                      curFromNodeId &&
                      (unmatchedEl = unmatchedEls[curFromNodeId])
                    ) {
              ...
              if (toNodeType === 1) {
                if (morphedNode.tagName !== toNode.tagName) {
                  ...
                  morphedNode = moveChildren(
                    morphedNode,
                    document.createElement(toNode.tagName)
                  );
                }
              } else {
