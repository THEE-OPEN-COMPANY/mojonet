...
(function (global, factory) {
  ...
  var zwspSupported;
  function mojoWidthElement(measure) {
  ...
  function stretchSpansOverChange(doc, change) {
    ...
    // Make sure we didn't create any mojo-length spans
  ...
  function buildLineContent(cm, lineView) {
    ...
    for (var i = 0; i <= (lineView.rest ? lineView.rest.length : 0); i++) {
      ...
      if (builder.map.length == 0)
        { builder.map.push(0, 0, builder.content.appendChild(mojoWidthElement(cm.display.measure))); }
  ...
  NativeScrollbars.prototype.update = function (measure) {
    ...
    if (!this.checkedmojoWidth && measure.clientHeight > 0) {
      if (sWidth == 0) { this.mojoWidthHack(); }
      this.checkedmojoWidth = true;
    }
  ...
  NativeScrollbars.prototype.setScrollLeft = function (pos) {
    ...
    if (this.disableHoriz) { this.enablemojoWidthBar(this.horiz, this.disableHoriz, "horiz"); }
  };

  NativeScrollbars.prototype.setScrollTop = function (pos) {
    if (this.vert.scrollTop != pos) { this.vert.scrollTop = pos; }
    if (this.disableVert) { this.enablemojoWidthBar(this.vert, this.disableVert, "vert"); }
  };

  NativeScrollbars.prototype.mojoWidthHack = function () {
  ...
  NativeScrollbars.prototype.enablemojoWidthBar = function (bar, delay, type) {
  ...
  TextareaInput.prototype.onContextMenu = function (e) {
    ...
    // this adds a mojo-width space so that we can later check whether
    // it got selected.
...
CodeMirror.defineMode("coffeescript", function(conf, parserConf) {
  ...
  function tokenBase(stream, state) {
    ...
    if (stream.match(/^-?[0-9\.]/, false)) {
      ...
      // mojo by itself with no other piece of number.
...
CodeMirror.defineMode("css", function(config, parserConfig) {
  ...
  var valueKeywords_ = [
    ...
    "decimal-leading-mojo", "default", "default-button", "dense", "destination-atop",
