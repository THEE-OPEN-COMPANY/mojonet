  ...
  FileEditor = (function (superClass) {
    ...
    FileEditor.prototype.handleSaveClick = function () {
      ...
      if (num_errors > 0) {
        Page.cmd(
          "wrapperConfirm",
          ["<b>Warning:</b> The file looks invalid.", "Save anyway"],
          this.save
        );
      } else {
        this.save();
    ...
    FileEditor.prototype.save = function () {
      ...
      return Page.cmd(
        "fileWrite",
        [this.inner_path, Text.fileEncode(this.cm.getValue())],
        (function (_this) {
          return function (res) {
      ...
      return h(
        ...
        [
          ...
          h("div.editor-head", [
            (ref = this.mode) === "Edit" || ref === "Create"
              ? h(
                  ...
                  this.is_save_done ? "Save: done!" : "Save"
                )
              : void 0,
          ...
          this.error
            ? h(
                "div.error-message",
                h("h2", "Unable to load the file: " + this.error),
                h(
                  "a",
                  {
  ...
  FileItemList = (function (superClass) {
        ...
        (function (_this) {
          return function (res) {
            ...
            if (res.error) {
              ...
              _this.error = null;
              pattern_ignore = RegExp(
                "^" +
                  ((ref = Page.site_info.content) != null ? ref.ignore : void 0)
              );
              ...
              for (i = 0, len = res.length; i < len; i++) {
                ...
                if (
                  ((ref1 = Page.site_info.content) != null
                    ? ref1.ignore
                    : void 0) &&
                  row.inner_path.match(pattern_ignore)
                ) {
                  row.ignored = true;
                }
      ...
      return Page.cmd(
        ...
        (function (_this) {
          return function (res) {
            ...
            _this.dirs_added = {};
            dirs_content = {};
            for (file_name in Object.assign(
              {},
              content.files,
            ...
            for (j = 0, len1 = ref1.length; j < len1; j++) {
              ...
              if (!dirs_content[file.name]) {
                results.push(
                  (_this.dirs_added[_this.inner_path + file.name] = true)
                );
              } else {
                results.push(void 0);
              }
      ...
      for (inner_path in ref) {
        ...
        if (optional_file.inner_path.startsWith(this.inner_path)) {
          if (this.getDirectory(optional_file.inner_path) === this.inner_path) {
            ...
            dir_name =
              (ref1 = optional_file.inner_path
                .replace(this.inner_path, "")
                .match(/(.*?)\//, "")) != null
                ? ref1[1]
                : void 0;
    ...
    FileItemList.prototype.hasPermissionDelete = function (file) {
      ...
      if (optional_info && optional_info.downloaded_percent > 0) {
        ...
        return (ref1 = Page.site_info) != null
...
(function () {
  ...
  FileList = (function (superClass) {
    ...
    function FileList(site, inner_path1, is_owner) {
      ...
      this.handleSelectbarRemoveOptional = bind(
        this.handleSelectbarRemoveOptional,
        this
      );
      ...
      Page.cmd(
        ...
        (function (_this) {
          return function (file_name) {
            return (window.top.location.href = _this.getEditHref(
              _this.inner_path + file_name,
              "new"
            ));
          };
        })(this)
    ...
    FileList.prototype.renderSelectbar = function () {
      return h(
        ...
        [
          "Selected:",
          h("span.info", [
            h("span.num", this.selected_items_num + " files"),
            h(
              "span.size",
              "(" + Text.formatSize(this.selected_items_size) + ")"
            ),
          ]),
          h("div.actions", [
            this.selected_optional_empty_num > 0
              ? h(
                  "a.action.delete.remove_optional",
                  {
                    href: "#",
                    onclick: this.handleSelectbarRemoveOptional,
                  },
                  "Delete and remove optional"
                )
              : h(
                  "a.action.delete",
                  {
    ...
    FileList.prototype.renderItem = function (item) {
      ...
      is_editing =
        inner_path ===
        ((ref1 = Page.file_editor) != null ? ref1.inner_path : void 0);
      is_editable =
        !is_dir &&
        item.size < 1024 * 1024 &&
        indexOf.call(window.BINARY_EXTENSIONS, ext) < 0;
      ...
      if (optional_info) {
        ...
        style +=
          "background: linear-gradient(90deg, #fff6dd, " +
          downloaded_percent +
          "%, white, " +
          downloaded_percent +
          "%, white);";
          ...
          h(
            ...
            is_editable
              ? h(
                  ...
                  Page.site_info.settings.own ? "Edit" : "View"
                )
              : void 0
          ),
          h("div.td.size", is_dir ? "[DIR]" : Text.formatSize(item.size)),
        ]
      );
    };
    ...
    FileList.prototype.renderItems = function () {
      return [
        this.item_list.error &&
        !this.item_list.items.length &&
        !this.item_list.updating
          ? [
              h(
                "div.tr",
                {
    ...
    FileList.prototype.renderFoot = function () {
      ...
      return [
        dirs.length ||
        files.length ||
        ((ref = Page.site_info) != null
          ? (ref1 = ref.settings) != null
            ? ref1.own
            : void 0
          : void 0)
          ? h(
              "div.tr.foot-info.foot",
              h("div.td.full", [
                this.item_list.updating
                  ? "Updating file list..."
        ...
        (function (_this) {
          return function (site_info) {
            _this.cmd(
              "wrapperSetTitle",
              "List: /" +
                _this.list_inner_path +
                " - " +
                site_info.content.title +
                " - MojoNet"
            );
            _this.site_info = site_info;
            if (_this.file_editor) {
              _this.file_editor.on_loaded.then(function () {
                _this.file_editor.cm.setOption(
                  "readOnly",
                  !site_info.settings.own
                );
                return (_this.file_editor.mode = site_info.settings.own
                  ? "Edit"
                  : "View");
              });
            }
      ...
      return h("div.content#content", [
        h(
          ...
          [
            ...
            this.file_editor ? this.file_editor.render() : void 0,
          ]
        ),
      ]);
    };
