...
(function () {
  ...
  ConfigStorage = (function (superClass) {
    ...
    ConfigStorage.prototype.createSections = function () {
      ...
      section.items.push({
        key: "open_browser",
        title: "Open web browser on MojoNet startup",
        type: "checkbox",
      });
      ...
      section.items.push({
        ...
        description:
          "Accept incoming peers using IPv4 or IPv6 address. (default: dual)",
      });
      section.items.push({
        key: "fileserver_port",
        ...
        valid_pattern: /[0-9]*/,
        description:
          "Other peers will use this port to reach your served sites. (default: randomize)",
      });
      section.items.push({
        key: "ip_external",
        ...
        description:
          "Your file server is accessible on these ips. (default: detect automatically)",
      });
      section.items.push({
        title: "Tor",
        key: "tor",
        ...
        description: [
          "Disable: Don't connect to peers on Tor network",
          h("br"),
          "Enable: Only use Tor for Tor network peers",
          h("br"),
      ...
      section.items.push({
        ...
        type: "checkbox",
        description:
          "Use obfuscated bridge relays to avoid network level Tor block (even slower)",
        isHidden: function () {
      ...
      section.items.push({
        ...
        type: "textarea",
        description:
          "Load additional list of torrent trackers dynamically, from a file",
      ...
      section.items.push({
        ...
        isHidden: (function (_this) {
          return function () {
            var ref;
            return (
              (ref = Page.values["trackers_proxy"]) === "tor" ||
              ref === "disable"
            );
          };
        })(this),
  ...
  ConfigView = (function (superClass) {
    ...
    ConfigView.prototype.renderSection = function (section) {
      return h(
        ...
        [
          h("h2", section.title),
          h("div.config-items", section.items.map(this.renderSectionItem)),
        ]
      );
    };
    ...
    ConfigView.prototype.handleResetClick = function (e) {
      ...
      default_value =
        (ref = node.attributes.default_value) != null ? ref.value : void 0;
      return Page.cmd(
        "wrapperConfirm",
        ["Reset " + config_key + " value?", "Reset to default"],
        (function (_this) {
          return function (res) {
            if (res) {
    ...
    ConfigView.prototype.renderSectionItem = function (item) {
      ...
      value_changed =
        this.config_storage.formatValue(this.values[item.key]) !== item.value;
      value_default =
        this.config_storage.formatValue(this.values[item.key]) ===
        item["default"];
      ...
      return h(
        ...
        [
          ...
          h(
            "div.value.value-" + value_pos,
            item.type === "select"
              ? this.renderValueSelect(item)
              : item.type === "checkbox"
              ? this.renderValueCheckbox(item)
              : item.type === "textarea"
              ? this.renderValueTextarea(item)
              : this.renderValueText(item),
            h(
              "a.marker",
              {
                href: "#Reset",
...
(function () {
  ...
  UiConfig = (function (superClass) {
    ...
    UiConfig.prototype.onOpenWebsocket = function () {
      this.cmd("wrapperSetTitle", "Config - MojoNet");
      this.cmd(
        "serverInfo",
        {},
        (function (_this) {
    ...
    UiConfig.prototype.createProjector = function () {
      ...
      return this.projector.replace(
        $("#bottom-restart"),
        this.renderBottomRestart
      );
    };
    ...
    UiConfig.prototype.getValuesChanged = function () {
      ...
      for (key in ref) {
        value = ref[key];
        if (
          this.config_storage.formatValue(value) !==
          this.config_storage.formatValue(
            (ref1 = this.config[key]) != null ? ref1.value : void 0
          )
        ) {
          values_changed.push({
            key: key,
    ...
    UiConfig.prototype.saveValues = function (cb) {
      ...
      for (i = j = 0, len = changed_values.length; j < len; i = ++j) {
        ...
        value = this.config_storage.deformatValue(
          item.value,
          typeof this.config[item.key]["default"]
        );
        default_value = this.config_storage.deformatValue(
          this.config[item.key]["default"],
          typeof this.config[item.key]["default"]
        );
        value_same_as_default =
          JSON.stringify(default_value) === JSON.stringify(value);
        if (
          this.config[item.key].item.valid_pattern &&
          !(typeof (base = this.config[item.key].item).isHidden === "function"
            ? base.isHidden()
            : void 0)
        ) {
          ...
          if (!match || match[0] !== value) {
            message =
              "Invalid value of " +
              this.config[item.key].item.title +
              ": " +
              value +
              " (does not matches " +
              this.config[item.key].item.valid_pattern +
    ...
    UiConfig.prototype.renderBottomSave = function () {
      ...
      return h(
        ...
        h("div.bottom-content", [
          h(
            "div.title",
            values_changed.length + " configuration item value changed"
          ),
          h(
            "a.button.button-submit.button-save",
            {
              href: "#Save",
              classes: {
    ...
    UiConfig.prototype.renderBottomRestart = function () {
      ...
      return h(
        ...
        h("div.bottom-content", [
          ...
          h(
            "a.button.button-submit.button-restart",
            {
              href: "#Restart",
              classes: {
