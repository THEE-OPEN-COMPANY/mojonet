...
(function() {
  ...
  Dashboard = (function(superClass) {
    ...
    Dashboard.prototype.handleTorClick = function() {
      var ref;
      this.menu_tor.items = [];
      this.menu_tor.items.push(["Status: " + ((ref = Page.server_info) != null ? ref.tor_status : void 0), Text.getSiteUrl("1DocsYf2tZVVMEMJFHiDsppmFicZCWkVv1") + "faq/#how-to-make-mojonet-work-with-tor-under-linux"]);
      if (this.getTorTitle() !== "OK") {
        this.menu_tor.items.push(["How to make Tor connection work?", Text.getSiteUrl("1DocsYf2tZVVMEMJFHiDsppmFicZCWkVv1") + "faq/#how-to-make-mojonet-work-with-tor-under-linux"]);
      }
      this.menu_tor.items.push(["How to use mojoNet in Tor Browser?", Text.getSiteUrl("1DocsYf2tZVVMEMJFHiDsppmFicZCWkVv1") + "faq/#how-to-use-mojonet-in-tor-browser"]);
    ...
    Dashboard.prototype.handleEnableAlwaysTorClick = function() {
      return Page.cmd("configSet", ["tor", "always"], (function(_this) {
        return function(res) {
          Page.cmd("wrapperNotification", ["done", "Tor always mode enabled, please restart your mojoNet to make it work.<br>For your privacy switch to Tor browser and start a new profile by renaming the data directory."]);
          return Page.cmd("wrapperConfirm", ["Restart mojoNet client?", "Restart now"], function(res) {
            if (res) {
    ...
    Dashboard.prototype.handleDisableAlwaysTorClick = function() {
      return Page.cmd("configSet", ["tor", null], (function(_this) {
        return function(res) {
          return Page.cmd("wrapperNotification", ["done", "Tor always mode disabled, please restart your mojoNet."]);
        };
      })(this));
    };
    ...
    Dashboard.prototype.handlePortClick = function() {
      ...
      if (Page.server_info.offline) {
        ...
        this.menu_port.items.push(["Good, your port is always closed when using mojoNet in Tor always mode.", Text.getSiteUrl("1DocsYf2tZVVMEMJFHiDsppmFicZCWkVv1") + "faq/#do-i-need-to-have-a-port-opened"]);
    ...
    Dashboard.prototype.handleDonateClick = function() {
      ...
      this.menu_donate.items.push(["Help to keep this project alive", Text.getSiteUrl("1DocsYf2tZVVMEMJFHiDsppmFicZCWkVv1") + "help_mojonet/donate/"]);
    ...
    Dashboard.prototype.handleNewversionClick = function() {
      ...
      this.menu_newversion.items.push([
        "Update mojoNet", (function() {
          return Page.updatemojonet();
        })
      ]);
      this.menu_newversion.items.push(["Details of the update", Text.getSiteUrl("Blog.mojoNetwork.bit")]);
    ...
    Dashboard.prototype.handleWarningsClick = function() {
      ...
      this.menu_warnings.items.push([
        "Restart mojoNet client", (function(_this) {
          return function() {
            return Page.cmd("serverShutdown", {
              restart: true
            });
    ...
    Dashboard.prototype.getWarnings = function(add_server_errors) {
      ...
      if (navigator.userAgent.match(/(\b(MS)?IE\s+|Trident\/7.0)/)) {
        warnings.push({
          ...
          descr: "Internet Explorer is not fully supported browser by mojoNet, please consider switching to Chrome or Firefox"
        });
      }
      if (this.isTorAlways() && (!navigator.userAgent.match(/(Firefox)/) || (navigator.maxTouchPoints != null) || (navigator.serviceWorker != null))) {
        warnings.push({
          ...
          href: Text.getSiteUrl("1DocsYf2tZVVMEMJFHiDsppmFicZCWkVv1") + "faq/#how-to-use-mojonet-in-tor-browser",
          descr: "To protect your anonymity you should use mojoNet in the Tor browser."
        });
      }
    ...
    Dashboard.prototype.render = function() {
      ...
      if (Page.server_info) {
        ...
        return h("div#Dashboard", num_warnings > 0 ? h("a.warnings.dashboard-item", {
          ...
          onclick: Page.returnFalse
        }, "New mojoNet version: " + Page.latest_version) : Page.server_info.rev < Page.latest_rev ? h("a.newversion.dashboard-item", {
          href: "#Update",
          onmousedown: this.handleNewversionClick,
          onclick: Page.returnFalse
  ...
  FeedList = (function(superClass) {
    ...
    FeedList.prototype.renderWelcome = function() {
      return h("div.welcome", [
        ...
        }), h("h1", "Welcome to mojoNet"), h("h2", "Let's build a decentralized Internet together!"), h("div.served", ["This site currently served by ", h("b.peers", Page.site_info["peers"] || "n/a"), " peers, without any central server."]), h("div.sites", [
          h("h3", "Some sites we created:"), h("a.site.site-mojotalk", {
            href: Text.getSiteUrl("Talk.mojoNetwork.bit")
          }, [h("div.title", ["mojoTalk"]), h("div.description", ["Reddit-like, decentralized forum"]), h("div.visit", ["Activate \u2501"])]), h("a.site.site-mojoblog", {
            href: Text.getSiteUrl("Blog.mojoNetwork.bit")
          }, [h("div.title", ["mojoBlog"]), h("div.description", ["Microblogging platform"]), h("div.visit", ["Activate \u2501"])]), h("a.site.site-mojomail", {
            href: Text.getSiteUrl("Mail.mojoNetwork.bit")
          }, [h("div.title", ["mojoMail"]), h("div.description", ["End-to-end encrypted mailing"]), h("div.visit", ["Activate \u2501"])]), h("a.site.site-mojome", {
            href: Text.getSiteUrl("Me.mojoNetwork.bit")
          }, [h("div.title", ["mojoMe"]), h("div.description", ["P2P social network"]), h("div.visit", ["Activate \u2501"])]), h("a.site.site-mojosites", {
            href: Text.getSiteUrl("Sites.mojoNetwork.bit")
          }, [h("div.title", ["mojoSites"]), h("div.description", ["Discover more sites"]), h("div.visit", ["Activate \u2501"])])
        ])
      ]);
    };
    ...
    FeedList.prototype.render = function() {
      ...
      return h("div#FeedList.FeedContainer", {
        ...
        h("div.feeds-filters", [
          ...
          }, "update"), " your mojoNet client to use the search feature!"
...
(function() {
  ...
  Site = (function(superClass) {
    ...
    Site.prototype.handleDeleteClick = function() {
      if (this.row.settings.own || this.row.privatekey) {
        Page.cmd("wrapperConfirm", ["You can delete your site using the site's sidebar.", ["Open site"]], (function(_this) {
          return function(confirmed) {
            if (confirmed) {
              return window.top.location = _this.getHref() + "#mojoNet:OpenSidebar";
            }
          };
        })(this));
      } else {
    ...
    Site.prototype.handleSettingsClick = function(e) {
      ...
      this.menu.items.push(["Save as .zip", "/mojoNet-Internal/Zip?address=" + this.row.address]);
    ...
    Site.prototype.handleLimitIncreaseClick = function() {
      if (Page.server_info.rev < 3170) {
        return Page.cmd("wrapperNotification", ["info", "You need mojoNet Rev3170 to use this command"]);
      }
  ...
  PageStats = (function(superClass) {
    ...
    PageStats.prototype.render = function() {
      ...
      if (((ref = Page.server_info) != null ? ref.rev : void 0) < 3220) {
        return h("div#PageStats", h("div.empty", [h("h4", "Need update"), h("small", "You have to update to mojoNet version 0.6.1 to use this feature.")]));
      }
      if (this.need_update) {
        this.update();
        this.need_update = false;
...
(function() {
  ...
  Text = (function() {
    ...
    Text.prototype.fixHtmlLinks = function(text) {
      if (window.is_proxy) {
        return text.replace(/href="http:\/\/(127.0.0.1|localhost):43110/g, 'href="http://mojo');
      } else {
...
(function() {
  ...
  Head = (function(superClass) {
    ...
    function Head() {
      ...
      this.handleShutdownmojonetClick = bind(this.handleShutdownmojonetClick, this);
    ...
    Head.prototype.handleLanguageClick = function(e) {
      ...
      if (Page.server_info.rev < 1750) {
        return Page.cmd("wrapperNotification", ["info", "You need mojoNet 0.5.1 to change the interface's language"]);
      }
    ...
    Head.prototype.handleThemeClick = function(e) {
      ...
      if (Page.server_info.rev < 3670) {
        return Page.cmd("wrapperNotification", ["info", "You need mojoNet 0.6.4 to change the interface's theme"]);
      }
      theme = e.target.hash.replace("#", "");
      if (theme === "system") {
        if (Page.server_info.rev < 4085) {
          return Page.cmd("wrapperNotification", ["info", "You need mojoNet 0.7.0 to use system's theme"]);
        }
    ...
    Head.prototype.handleCreateSiteClick = function() {
      if (Page.server_info.rev < 1770) {
        return Page.cmd("wrapperNotification", ["info", "You need to update your mojoNet client to use this feature"]);
      }
    ...
    Head.prototype.handleSettingsClick = function() {
      ...
      this.menu_settings.items.push(["Version " + Page.server_info.version + " (rev" + Page.server_info.rev + "): " + (this.formatUpdateInfo()), this.handleUpdatemojonetClick]);
      if (!Page.server_info.multiuser || Page.server_info.multiuser_admin) {
        this.menu_settings.items.push(["Shut down mojoNet", this.handleShutdownmojonetClick]);
      }
    ...
    Head.prototype.handleManageBlocksClick = function() {
      if (Page.server_info.rev < 1880) {
        return Page.cmd("wrapperNotification", ["info", "You need mojoNet 0.5.2 to use this feature."]);
      }
    ...
    Head.prototype.handleUpdatemojonetClick = function() {
      if (Page.server_info.updatesite) {
        ...
        Page.cmd("wrapperConfirm", ["Update to latest development version?", "Update mojoNet " + Page.latest_version], (function(_this) {
          return function() {
            return Page.updatemojonet();
          };
        })(this));
    ...
    Head.prototype.handleShutdownmojonetClick = function() {
      return Page.cmd("wrapperConfirm", ["Are you sure?", "Shut down mojoNet"], (function(_this) {
        return function() {
          return Page.cmd("serverShutdown");
        };
      })(this));
    ...
    Head.prototype.handleModeClick = function(e) {
      if (Page.server_info.rev < 1700) {
        Page.cmd("wrapperNotification", ["info", "This feature requires mojoNet version 0.5.0"]);
      } else {
  ...
  mojoHello = (function(superClass) {
    ...
    mojoHello.prototype.updatemojonet = function() {
      if (this.server_info.updatesite) {
        ...
        Page.cmd("wrapperNotification", ["info", "Updating to latest version...<br>Please restart mojoNet manually if it does not come back in the next few minutes.", 8000]);
