  ...
  Class = (function () {
    ...
    Class.prototype.logStart = function () {
      ...
      if (args.length > 0) {
        this.log.apply(
          this,
          ["" + name].concat(slice.call(args), ["(started)"])
        );
      }
      return this;
    };
    ...
    Class.prototype.logEnd = function () {
      ...
      this.log.apply(
        this,
        ["" + name].concat(slice.call(args), ["(Done in " + ms + "ms)"])
      );
      return this;
    };
...
(function (root, factory) {
    ...
    for (var i = 0; i < propCount; i++) {
      ...
      if (propName === "class") {
        ...
        if (propName === "value") {
          if (
            domNode[propName] !== propValue &&
            domNode["oninput-value"] !== propValue
          ) {
            domNode[propName] = propValue;
  ...
  var updateChildren = function (
    ...
    while (newIndex < newChildrenLength) {
      ...
      if (oldChild !== undefined && same(oldChild, newChild)) {
        ...
        var findOldIndex = findIndexOfChild(
          oldChildren,
          newChild,
          oldIndex + 1
        );
        ...
        if (i === vnodeSelector.length || c === "." || c === "#") {
          ...
          if (type === ".") {
            ...
            if (projectionOptions.namespace !== undefined) {
              domNode = vnode.domNode = document.createElementNS(
  ...
  exports.h = function (selector) {
    ...
    if (
      properties &&
      !properties.hasOwnProperty("vnodeSelector") &&
      ...
      return Page.cmd(
        ...
        (function (_this) {
          return function (res) {
            ...
            _this.files.items = res.slice(
              0,
              +(_this.files.limit - 1) + 1 || 9e9
            );
    ...
    FilesResult.prototype.render = function () {
      if (Page.server_info.rev < 4120) {
        return h("div.empty", [
          ...
          h(
            "small",
            "You need to update to the latest version to use this feature"
          ),
        ]);
      }
      ...
      return h("div.site", [
        h("div.title", [
          h("h3.name", "Filter result: " + this.filter_inner_path),
        ]),
        this.files.render(),
      ]);
    };
...
(function () {
  ...
  PageFiles = (function (superClass) {
    ...
    PageFiles.prototype.handleSelectbarDelete = function () {
        ...
        if (selected_site_files.length > 0) {
          for (j = 0, len1 = selected_site_files.length; j < len1; j++) {
            ...
            Page.cmd("optionalFileDelete", [
              selected_site_file.inner_path,
              site.row.address,
            ]);
            if (site.files.mode === "bigfiles") {
              Page.cmd("optionalFileDelete", [
                selected_site_file.inner_path + ".piecemap.msgpack",
                site.row.address,
              ]);
      ...
      if (bigfiles_modified_sites) {
        ...
        for (k = 0, len2 = ref1.length; k < len2; k++) {
          site = ref1[k];
          if (
            ((ref2 = site.row.address),
            indexOf.call(bigfiles_modified_sites, ref2) >= 0)
          ) {
            site.files.update();
          }
        }
    ...
    PageFiles.prototype.handleTotalbarMenu = function () {
      ...
      this.menu_totalbar.items.push([
        "Edit optional files limit",
        this.handleEditlimitClick,
      ]);
    ...
    PageFiles.prototype.renderTotalbar = function () {
      ...
      var limit,
        percent_limit,
        percent_optional_downloaded,
        percent_optional_used,
        total_space_limited;
      ...
      percent_optional_used =
        percent_optional_downloaded * (limit / total_space_limited);
      percent_limit = (limit / total_space_limited) * 100;
      return h(
        "div#PageFilesDashboard",
        {
          classes: {
        ...
        [
          ...
          h(
            ...
            "Used: " +
              Text.formatSize(this.optional_stats.used) +
              " / " +
              Text.formatSize(limit) +
              " (" +
              Math.round(percent_optional_downloaded) +
              "%)",
              ...
              h(
                ...
                [
                  ...
                  h(
                    ...
                    {
                      style:
                        this.optional_stats.free > total_space_limited
                          ? "width: 10px"
                          : "width: 0px",
                    },
                    " \u25B6"
      ...
      return h(
        ...
        [
          ...
          h("span.info", [
            ...
            h(
              "span.size",
              "(" + Text.formatSize(this.selected_files_size) + ")"
            ),
          ]),
          h("div.actions", [
    ...
    PageFiles.prototype.handleFilterInput = function (e) {
      ...
      return (this.input_timer = setTimeout(
        (function (_this) {
          return function () {
    ...
    PageFiles.prototype.render = function () {
      ...
      return h("div#PageFiles", [
        ...
        this.renderTotalbar(),
        this.renderFilter(),
        this.result.filter_inner_path
          ? this.result.render()
          : [
              this.bigfiles.render(),
              sites_favorited.slice(0, +this.display_limit + 1 || 9e9).map(
                (function (_this) {
                  return function (site) {
              ...
              sites_connected.slice(0, +this.display_limit + 1 || 9e9).map(
                (function (_this) {
                  return function (site) {
                    return site.renderOptionalStats();
                  };
    ...
    PageFiles.prototype.onSiteInfo = function (site_info) {
      ...
      if (
        ((ref = site_info.event) != null ? ref[0] : void 0) === "peers_added"
      ) {
        return false;
      }
      if (
        site_info.tasks === 0 &&
        ((ref1 = site_info.event) != null ? ref1[0] : void 0) === "file_done"
      ) {
        rate_limit = 1000;
      } else {
        rate_limit = 10000;
...
(function () {
  ...
  SiteFiles = (function (superClass) {
    ...
    SiteFiles.prototype.isSelectedAll = function () {
      return (
        !this.has_more &&
        Object.keys(this.selected).length === this.items.length
      );
    };
        ...
        h(
          ...
          [
            h("div.tr.thead", [
              ...
              this.mode === "bigfiles" || this.mode === "result"
                ? h("div.td.site", this.renderOrder("Site", "address"))
                : void 0,
              h(
                "div.td.inner_path",
                this.renderOrder("Optional file", "is_pinned DESC, inner_path")
              ),
              ...
              h(
                "div.td.added",
                this.renderOrder("Finished", "time_downloaded")
              ),
            ]),
            h(
              "div.tbody",
                  ...
                  return function (file) {
                    ...
                    if (_this.mode === "bigfiles") {
                      ...
                      if (file.pieces === 0 || file.pieces_downloaded === 0) {
                        ...
                        percent = parseInt(
                          (file.pieces_downloaded / file.pieces) * 100
                        );
                      }
                    ...
                    return h(
                      ...
                      [
                        ...
                        _this.mode === "bigfiles" || _this.mode === "result"
                          ? h(
                              "div.td.site",
                              h(
                                "a.link",
                          ...
                          h("div.dots-container", [
                            h(
                              "span.dots.dots-bg",
                              {
                                title:
                                  "Ratio: " +
                                  (file.uploaded / file.size).toFixed(1),
                              },
                              "\u2022\u2022\u2022\u2022\u2022"
                            ),
                            h(
                              "span.dots.dots-fg",
                              {
                                ...
                                style:
                                  "width: " +
                                  Math.min(5, file.uploaded / file.size) * 9 +
                                  "px",
                              },
                              "\u2022\u2022\u2022\u2022\u2022"
                            ),
                        ...
                        h(
                          "div.td.added",
                          file.time_downloaded
                            ? Time.since(file.time_downloaded)
                            : "n/a"
                        ),
                      ]
                    );
...
(function () {
  ...
  Dashboard = (function (superClass) {
    ...
    function Dashboard() {
      ...
      this.handleDisableAlwaysTorClick = bind(
        this.handleDisableAlwaysTorClick,
        this
      );
      this.handleEnableAlwaysTorClick = bind(
        this.handleEnableAlwaysTorClick,
        this
      );
    ...
    Dashboard.prototype.handleTorClick = function () {
      ...
      this.menu_tor.items.push([
        "Status: " +
          ((ref = Page.server_info) != null ? ref.tor_status : void 0),
        Text.getSiteUrl("1DocsYf2tZVVMEMJFHiDsppmFicZCWkVv1") +
          "faq/#how-to-make-mojonet-work-with-tor-under-linux",
      ]);
      if (this.getTorTitle() !== "OK") {
        this.menu_tor.items.push([
          "How to make Tor connection work?",
          Text.getSiteUrl("1DocsYf2tZVVMEMJFHiDsppmFicZCWkVv1") +
            "faq/#how-to-make-mojonet-work-with-tor-under-linux",
        ]);
      }
      this.menu_tor.items.push([
        "How to use mojoNet in Tor Browser?",
        Text.getSiteUrl("1DocsYf2tZVVMEMJFHiDsppmFicZCWkVv1") +
          "faq/#how-to-use-mojonet-in-tor-browser",
      ]);
      this.menu_tor.items.push(["---"]);
      if (this.isTorAlways()) {
        this.menu_tor.items.push([
          "Disable always Tor mode",
          this.handleDisableAlwaysTorClick,
        ]);
      } else {
        this.menu_tor.items.push([
        ...
        (function (_this) {
          return function (res) {
            Page.cmd("wrapperNotification", [
              "done",
              "Tor always mode enabled, please restart your mojoNet to make it work.<br>For your privacy switch to Tor browser and start a new profile by renaming the data directory.",
            ]);
            return Page.cmd(
              "wrapperConfirm",
              ["Restart mojoNet client?", "Restart now"],
              function (res) {
                if (res) {
    ...
    Dashboard.prototype.handleDisableAlwaysTorClick = function () {
      return Page.cmd(
        ...
        (function (_this) {
          return function (res) {
            return Page.cmd("wrapperNotification", [
              "done",
              "Tor always mode disabled, please restart your mojoNet.",
            ]);
          };
        })(this)
      );
    ...
    Dashboard.prototype.handlePortClick = function () {
      ...
      if (Page.server_info.offline) {
        this.menu_port.items.push([
          "Offline mode, network communication disabled.",
          "/Config",
        ]);
      } else if (Page.server_info.ip_external) {
        this.menu_port.items.push([
          "Nice! Your port " + Page.server_info.fileserver_port + " is opened.",
          Text.getSiteUrl("1DocsYf2tZVVMEMJFHiDsppmFicZCWkVv1") +
            "faq/#do-i-need-to-have-a-port-opened",
        ]);
      } else if (this.isTorAlways()) {
        this.menu_port.items.push([
          "Good, your port is always closed when using mojoNet in Tor always mode.",
          Text.getSiteUrl("1DocsYf2tZVVMEMJFHiDsppmFicZCWkVv1") +
            "faq/#do-i-need-to-have-a-port-opened",
        ]);
        ...
        this.menu_port.items.push([
          "Your port " +
            Page.server_info.fileserver_port +
      ...
      if (Page.server_info.port_opened) {
        ...
        this.menu_port.items.push([
          [
            "IPv4: ",
            format[port_opened.ipv4],
            ", IPv6: ",
            format[port_opened.ipv6],
          ],
          null,
        ]);
      }
      this.menu_port.items.push(["---"]);
      this.menu_port.items.push([
        "Re-check opened port",
        this.handlePortRecheckClick,
      ]);
    ...
    Dashboard.prototype.handleNewversionClick = function () {
      ...
      this.menu_newversion.items.push([
        "Update mojoNet",
        function () {
          return Page.updatemojonet();
        },
      ]);
      this.menu_newversion.items.push([
        "Details of the update",
        Text.getSiteUrl("Blog.mojoNetwork.bit"),
      ]);
      ...
      for (tracker_url in stats) {
        ...
        if (stat.last_error) {
          title_text +=
            ...
            stat.last_error +
            " (" +
            Time.since(stat.time_last_error) +
            ")";
        }
        title = [
          tracker_name,
    ...
    Dashboard.prototype.handleWarningsClick = function () {
      ...
      for (i = 0, len = warnings.length; i < len; i++) {
        ...
        this.menu_warnings.items.push([
          h("b.status-error", warning.title),
          warning.href,
        ]);
        if (warning.descr) {
    ...
    Dashboard.prototype.getWarnings = function (add_server_errors) {
      ...
      if (navigator.userAgent.match(/(\b(MS)?IE\s+|Trident\/7.0)/)) {
        warnings.push({
          ...
          descr:
            "Internet Explorer is not fully supported browser by mojoNet, please consider switching to Chrome or Firefox",
        });
      }
      if (
        this.isTorAlways() &&
        ...
        warnings.push({
          ...
          href:
            ...
            "faq/#how-to-use-mojonet-in-tor-browser",
          descr:
            "To protect your anonymity you should use mojoNet in the Tor browser.",
        });
      }
      if (Page.server_info.lib_verify_best === "btctools") {
        warnings.push({
          ...
          href: "#",
          descr:
            "To significantly reduce CPU usage install libsecp256k1 or OpenSSL",
        });
      }
      if (Math.abs(Page.server_info.timecorrection) > 30) {
        warnings.push({
          title: [
            "Time out of sync: ",
            0 - Page.server_info.timecorrection.toFixed(2),
            "s",
          ],
          href: "https://time.is",
          descr:
            "Looks like your system time is out of sync. Other users may not see your posted content and other problems could happen.",
        });
      }
      ...
      if (Page.server_info) {
        ...
        return h(
          ...
          num_warnings > 0
            ...
            : void 0,
          this.menu_warnings.render(".menu-warnings"),
          parseFloat(Page.server_info.version.replace(/\./g, "0")) <
            parseFloat(Page.latest_version.replace(/\./g, "0"))
            ? h(
                "a.newversion.dashboard-item",
                {
                  href: "#Update",
                  onmousedown: this.handleNewversionClick,
                  onclick: Page.returnFalse,
                },
                "New mojoNet version: " + Page.latest_version
              )
            : Page.server_info.rev < Page.latest_rev
            ? h(
                "a.newversion.dashboard-item",
                {
                  href: "#Update",
                ...
                "New important update: rev" + Page.latest_rev
              )
            : void 0,
          this.menu_newversion.render(".menu-newversion"),
          h(
            "a.port.dashboard-item.donate",
            {
              href: "#Donate",
          ...
          Page.server_info.multiuser
            ? h(
                "a.port.dashboard-item.multiuser",
                {
                  href: "#Multiuser",
                ...
                [
                  ...
                  h(
                    "span.status",
                    {
                      style:
                        "color: " +
                        Text.toColor(Page.server_info.master_address),
                    },
                    Page.server_info.master_address.slice(0, 5) +
                      ".." +
                      Page.server_info.master_address.slice(-4)
                  ),
                ]
              )
            : void 0,
          Page.server_info.multiuser
            ? this.menu_multiuser.render(".menu-multiuser")
            : void 0,
          indexOf.call(Page.server_info.plugins, "UiPassword") >= 0
            ? h(
                "a.port.dashboard-item.logout",
                {
                  href: "#Logout",
            ...
            : void 0,
          this.menu_port.render(".menu-port.menu-left"),
          h(
            "a.dashboard-item.port",
            {
              href: "#Port",
              classes: {
          ...
          Page.announcer_info || Page.announcer_stats
            ? h(
                "a.dashboard-item.trackers",
                {
                  href: "#Trackers",
                  onmousedown: this.handleTrackersClick,
                  onclick: Page.returnFalse,
                },
                [h("span", "Trackers: "), this.tagTrackersTitle()]
              )
            : void 0,
          this.menu_trackers.render(".menu-trackers")
        );
      } else {
...
(function () {
  ...
  FeedList = (function (superClass) {
    ...
    function FeedList() {
      ...
      this.handleNotificationHideClick = bind(
        this.handleNotificationHideClick,
        this
      );
    ...
    FeedList.prototype.checkScroll = function () {
      ...
      if (
        scroll_top + window.innerHeight >
          document.getElementById("FeedList").clientHeight - 400 &&
        !this.updating &&
        ((ref = this.feeds) != null ? ref.length : void 0) > 5 &&
        Page.mode === "Sites" &&
        this.limit < 300
      ) {
        this.limit += 30;
    ...
    FeedList.prototype.displayRows = function (rows, search) {
      ...
      for (i = 0, len = rows.length; i < len; i++) {
        row = rows[i];
        if (
          last_row.body === row.body &&
          last_row.date_added === row.date_added
        ) {
          continue;
        }
        if (
          row_group.type === row.type &&
          row.url === row_group.url &&
          row.site === row_group.site
        ) {
        ...
        (function (_this) {
          return function (res) {
            ...
            if (rows.length < 10 && _this.query_day_limit !== null) {
              _this.log(
                "Only " + res.rows.length + " results, query without day limit"
              );
        ...
        (function (_this) {
          return function (res) {
            ...
            if (res.rows.length < 10 && _this.query_day_limit !== null) {
              _this.log(
                "Only " + res.rows.length + " results, search without day limit"
              );
    ...
    FeedList.prototype.storeNodeSearch = function (node) {
      return (document.body.onkeypress = (function (_this) {
        return function (e) {
          ...
          if (
            ((ref1 = document.activeElement) != null
              ? ref1.tagName
              : void 0) !== "INPUT"
          ) {
            return node.focus();
        ...
        if (this.searching_text && this.searching_text.length > 1) {
          ...
          if (body[0].length > 60 && body.length > 1) {
            body[0] =
              ...
              body[0].slice(
                body[0].length - 50,
                +(body[0].length - 1) + 1 || 9e9
              );
          }
          return [
            h("b", Text.highlight(username_formatted, this.searching_text)),
            body,
          ];
        } else {
        ...
        return h(
          ...
          [
            ...
            h("div.circle", {
              style:
                "border-color: " +
                Text.toColor(feed.type + site.row.address, 60, 60),
            }),
            h("div.title-container", [
              type_formatted ? h("span.type", type_formatted) : void 0,
              h(
                "a.title",
                {
            ...
            h(
              ...
              this.formatBody(feed.body, feed.type)
            ),
            feed.body_more
              ? feed.body_more.map(
                  (function (_this) {
    ...
    FeedList.prototype.renderWelcome = function () {
      return h("div.welcome", [
        ...
        h("div.served", [
          "This site currently served by ",
          h("b.peers", Page.site_info["peers"] || "n/a"),
          " peers, without any central server.",
        ]),
        h("div.sites", [
          h("h3", "Some sites we created:"),
          h(
            "a.site.site-mojotalk",
            {
              href: Text.getSiteUrl("Talk.mojoNetwork.bit"),
            },
            [
          ...
          h(
            "a.site.site-mojoblog",
            {
              href: Text.getSiteUrl("Blog.mojoNetwork.bit"),
            },
            [
          ...
          h(
            "a.site.site-mojomail",
            {
              href: Text.getSiteUrl("Mail.mojoNetwork.bit"),
            },
            [
          ...
          h(
            "a.site.site-mojome",
            {
              href: Text.getSiteUrl("Me.mojoNetwork.bit"),
            },
            [
              h("div.title", ["mojoMe"]),
          ...
          h(
            "a.site.site-mojosites",
            {
              href: Text.getSiteUrl("Sites.mojoNetwork.bit"),
            },
            [
      ...
      back.push(
        h(
          ...
          [
            ...
            h("td.taken", stat.taken != null ? stat.taken + "s" : "n/a "),
          ]
        )
      );
      if (stat.error) {
    ...
    FeedList.prototype.renderNotifications = function () {
      return h(
        ...
        [
          Page.mute_list.siteblocks_serving.map(
            (function (_this) {
                ...
                return h(
                  ...
                  [
                    ...
                    h(
                      ...
                      siteblock.site.row.content.title ||
                        siteblock.site.row.address_short
                    ),
                    h("span.reason", [
                      h(
                        "a.title",
    ...
    FeedList.prototype.render = function () {
      ...
      if (
        this.feeds &&
        Page.settings.date_feed_visit <
          ((ref = this.feeds[0]) != null ? ref.date_added : void 0)
      ) {
        this.saveFeedVisit(this.feeds[0].date_added);
      }
      if (
        this.feeds &&
        Page.site_list.loaded &&
        document.body.className !== "loaded" &&
        !this.updating
      ) {
      ...
      return h(
        "div#FeedList.FeedContainer",
        {
          classes: {
            faded: Page.mute_list.visible,
          },
        },
        Page.mute_list.updated ? this.renderNotifications() : void 0,
          ...
          ? [
              ...
              h(
                ...
                this.loading
                  ...
                  : void 0,
                this.searched && !this.loading
                  ? h(
                      "a.search-clear.nolink",
                      {
                        href: "#clear",
                  ...
                  : void 0,
                ((ref1 = this.res) != null ? ref1.stats : void 0)
                  ? h(
                      "a.search-info.nolink",
                      {
                        href: "#ShowStats",
                        enterAnimation: Animation.show,
                        exitAnimation: Animation.hide,
                      ...
                      (this.searching ? this.res.num + " results " : "") +
                        ("from " +
                          this.res.sites +
                          " sites in " +
                          this.res.taken.toFixed(2) +
                          "s")
                    )
                  : void 0,
                h("input", {
                  ...
                  ? h(
                      ...
                      [
                        h("table", [
                          ...
                          this.res.stats.map(this.renderSearchStat),
                        ]),
                      ]
                    )
                  : void 0,
                this.renderSearchHelp(),
                Page.server_info.rev < 1230 && this.searching
                  ? h(
                      "div.search-noresult",
                      {
                        enterAnimation: Animation.show,
                      ...
                      [
                        ...
                        h(
                          ...
                          {
                            href: "#Update",
                            onclick: Page.head.handleUpdatemojonetClick,
                          },
                          "update"
                        ),
                        " your mojoNet client to use the search feature!",
                      ]
                    )
                  : this.feeds.length === 0 && this.searched
                  ? h(
                      "div.search-noresult",
                      {
                        enterAnimation: Animation.show,
                      },
                      "No results for " + this.searched
                    )
                  : void 0
              ),
              h(
                "div.FeedList." + this.getClass(),
                {
                  classes: {
                    loading: this.loading || this.waiting,
                  },
    ...
    FeedList.prototype.onSiteInfo = function (site_info) {
      var ref, ref1, ref2;
      if (
        ((ref = site_info.event) != null ? ref[0] : void 0) === "file_done" &&
        ((ref1 = site_info.event) != null
          ? ref1[1].endsWith(".json")
          : void 0) &&
        !((ref2 = site_info.event) != null
          ? ref2[1].endsWith("content.json")
          : void 0)
      ) {
        if (!this.searching) {
        ...
        (function (_this) {
          return function (res) {
            ...
            for (j = 0, len1 = ref2.length; j < len1; j++) {
              ...
              if (
                _this.siteblocks[address] &&
                !Page.settings.siteblocks_ignore[address]
              ) {
              ...
              if (
                _this.siteblocks[address_hash] &&
                !Page.settings.siteblocks_ignore[address_hash]
              ) {
                ...
                [
                  ...
                  h(
                    ...
                    [
                      ...
                      h(
                        "div.date_added",
                        " \u2500 " + Time.since(siteblock.date_added)
                      ),
                    ]
                  ),
                ]
                ...
                [
                  h(
                    ...
                    h(
                      ...
                      include.site.row.content.title
                    ),
                    " \u203A ",
                    h(
                      "a.inner_path",
                  ...
                  include.mutes.length
                    ? _this.renderMutes(include.mutes, "includes")
                    : void 0,
                  include.siteblocks.length
                    ? _this.renderSiteblocks(include.siteblocks)
                    : void 0,
                ]
              );
            };
    ...
    MuteList.prototype.render = function () {
      ...
      return h(
        ...
        [
          ...
          ((ref = this.mutes) != null ? ref.length : void 0) === 0 &&
          ((ref1 = this.includes) != null ? ref1.length : void 0) === 0
            ...
            : h(
                ...
                [
                  this.mutes.length > 0 ? this.renderMutes(this.mutes) : void 0,
                  this.includes ? this.renderIncludes() : void 0,
                ]
              ),
        ]
      );
...
(function () {
  ...
  Site = (function (superClass) {
    ...
    Site.prototype.setRow = function (row) {
      ...
      if (
        ((ref = row.event) != null ? ref[0] : void 0) === "updated" &&
        row.content_updated !== false
      ) {
        this.setMessage("Updated!", "done");
      } else if (
        ((ref1 = row.event) != null ? ref1[0] : void 0) === "updating"
      ) {
        this.setMessage("Updating...");
      } else if (row.tasks > 0) {
        this.setMessage(
          "Updating: " + Math.max(row.tasks, row.bad_files) + " left"
        );
        ...
        row.tasks === 0 &&
        ((ref2 = this.row) != null ? ref2.tasks : void 0) > 0
      ) {
        this.setMessage("Updated!", "done");
      }
      if (row.body == null) {
    ...
    Site.prototype.isWorking = function () {
      ...
      return (
        this.row.tasks > 0 ||
        ((ref = this.row.event) != null ? ref[0] : void 0) === "updating"
      );
    };
    ...
    Site.prototype.handleCloneUpgradeClick = function () {
      Page.cmd(
        ...
        [
          "Are you sure?" +
            (" Any modifications you made on<br><b>" +
              this.row.content.title +
              "</b> site's js/css files will be lost."),
          "Upgrade",
        ],
        (function (_this) {
    ...
    Site.prototype.handleDeleteClick = function () {
      if (this.row.settings.own || this.row.privatekey) {
        Page.cmd(
          "wrapperConfirm",
          ["You can delete your site using the site's sidebar.", ["Open site"]],
          (function (_this) {
            return function (confirmed) {
              if (confirmed) {
                return (window.top.location =
                  _this.getHref() + "#mojoNet:OpenSidebar");
              }
            };
          })(this)
        );
        ...
        if (!this.row.content.title) {
          ...
          Page.cmd(
            "wrapperConfirm",
            [
              "Are you sure?" + (" <b>" + this.row.content.title + "</b>"),
              ["Delete", "Blacklist"],
            ],
            (function (_this) {
              return function (confirmed) {
                if (confirmed === 1) {
                  ...
                  return Page.cmd(
                    "wrapperPrompt",
                    [
                      "Blacklist <b>" + _this.row.content.title + "</b>",
                      "text",
    ...
    Site.prototype.handleSettingsClick = function (e) {
      ...
      this.menu.items.push([
        "Save as .zip",
        "/mojoNet-Internal/Zip?address=" + this.row.address,
      ]);
      if (this.row.content.cloneable === true) {
        this.menu.items.push(["Clone", this.handleCloneClick]);
      }
      if (
        this.row.settings.own &&
        this.row.content.cloned_from &&
        Page.server_info.rev >= 2080
      ) {
        this.menu.items.push(["---"]);
    ...
    Site.prototype.handleHelpsClick = function (e) {
      ...
      this.menu_helps.items.push([
        "Help distribute all new files",
        this.handleHelpAllClick,
        (function (_this) {
          return function () {
    ...
    Site.prototype.getHref = function (row) {
      ...
      if ((ref = this.row.content) != null ? ref.domain : void 0) {
        ext =
          (ref1 = this.row.content) != null
            ? ref1.domain.split(".").pop()
            : void 0;
        supported_plugins =
          {
            bit: ["mojoname", "Dnschain", "mojoname-local"],
            yo: ["NameYo"],
            yu: ["NameYo"],
            of: ["NameYo"],
            inf: ["NameYo"],
        ...
        has_plugin =
          ((ref2 = Page.server_info) != null ? ref2.plugins : void 0) != null &&
          supported_plugins.some(function (plugin) {
            var ref3;
            return (
              indexOf.call(
                (ref3 = Page.server_info) != null ? ref3.plugins : void 0,
                plugin
              ) >= 0
            );
          });
      ...
      if (
        has_plugin &&
        ((ref3 = this.row.content) != null ? ref3.domain : void 0)
      ) {
    ...
    Site.prototype.handleLimitIncreaseClick = function () {
      if (Page.server_info.rev < 3170) {
        return Page.cmd("wrapperNotification", [
          "info",
          "You need mojoNet Rev3170 to use this command",
        ]);
      }
      Page.cmd(
        "as",
        [this.row.address, "siteSetLimit", this.row.need_limit],
        (function (_this) {
          return function (res) {
            if (res === "ok") {
              Page.cmd("wrapperNotification", [
                "done",
                "Site <b>" +
                  _this.row.content.title +
                  "</b> storage limit modified to <b>" +
                  _this.row.need_limit +
                  "MB</b>",
                5000,
              ]);
            } else {
      ...
      return h(
        ...
        h(
          "a.inner",
          {
            href: this.getHref(),
            title:
              ((ref = this.row.content.title) != null ? ref.length : void 0) >
              20
                ? this.row.content.title
                : void 0,
          },
            ...
            h("div.details", [
              h("span.modified", [
                ...
                Page.settings.sites_orderby === "size"
                  ? h("span.value", [
                      (
                        this.row.settings.size / 1024 / 1024 +
                        (this.row.settings.size_optional != null) / 1024 / 1024
                      ).toFixed(1),
                      "MB",
                    ])
              ...
              h("span.peers", [
                ...
                h("span.value", [
                  Math.max(
                    this.row.settings.peers ? this.row.settings.peers : 0,
                    this.row.peers
                  ),
                ]),
              ]),
            ]),
            this.row.demo ? h("div.details.demo", "Activate \u00BB") : void 0,
            this.row.need_limit
              ? h(
                  ...
                  "Set limit to " + this.row.need_limit + "MB"
                )
              : void 0,
            h(
              "div.message",
    ...
    Site.prototype.renderOptionalStats = function () {
      ...
      ratio_hue = Math.min(
        555,
        (row.settings.bytes_sent / row.settings.bytes_recv) * 50
      );
      return h(
        "div.site",
        {
          ...
          h("div.title", [
            ...
            h(
              "div.size",
              {
                title:
                  "Site size limit: " +
                  Text.formatSize(row.size_limit * 1024 * 1024),
              },
              [
                ...
                h(
                  ...
                  h("div.bar-active", {
                    style:
                      "width: " +
                      100 *
                        (row.settings.size / (row.size_limit * 1024 * 1024)) +
                      "%",
                  })
                ),
              ]
            ...
            h("div.plus", "+"),
            h(
              "div.size.size-optional",
              {
                title:
                  "Optional files on site: " +
                  Text.formatSize(row.settings.size_optional),
              },
              [
                ...
                h(
                  ...
                  h("div.bar-active", {
                    style:
                      "width: " +
                      100 *
                        (row.settings.optional_downloaded /
                          row.settings.size_optional) +
                      "%",
                  })
                ),
              ]
            ...
            h(
              ...
              h("div.icon-share"),
              this.row.settings.autodownloadoptional
                ? "\u2661"
                : this.optional_helps.length,
              h("div.icon-arrow-down"),
              this.menu_helps ? this.menu_helps.render() : void 0
            ),
            this.renderCircle(
              parseFloat(
                (row.settings.bytes_sent / row.settings.bytes_recv).toFixed(1)
              ),
              10
            ),
            h(
            ...
            h("div.transfers", [
              h(
                ...
                "\u22F0 \u00A0" + Text.formatSize(row.settings.bytes_sent)
              ),
              h(
                "div.down",
                {
...
(function () {
  ...
  SiteList = (function (superClass) {
    ...
    SiteList.prototype.reorderTimer = function () {
      ...
      if (
        !document.querySelector(".left:hover") &&
    ...
    SiteList.prototype.sortRows = function (rows) {
      if (Page.settings.sites_orderby === "modified") {
        ...
        rows.sort(function (a, b) {
          return (
            Math.max(b.row.peers, b.row.settings.peers) -
    ...
    SiteList.prototype.updateInactiveDemoSites = function () {
      ...
      demo_site_rows = [
        ...
        },
        {
          ...
          demo: true,
          content: {
            title: "More @ mojoSites",
            domain: "Sites.mojoNetwork.bit",
          },
          settings: {},
        },
      ];
      ...
      for (i = 0, len = demo_site_rows.length; i < len; i++) {
        ...
        if (
          ...
          site.row.content.title
            .toLowerCase()
            .indexOf(this.filtering.toLowerCase()) === -1
        ) {
          continue;
        }
    ...
    SiteList.prototype.renderSection = function (
      class_name,
      title,
      items,
      limit
      ...
      return [
        h(
          "h2.SiteSection.section" + class_name,
          {
            classes: classes,
          },
          h(
            ...
            [title, h("span.hide-title", "[Show " + items.length + " sites]")]
          )
        ),
        !classes.hidden
          ? h(
              "div.SiteList" + class_name,
              {
                classes: classes,
                exitAnimation: Animation.slideUp,
                enterAnimation: Animation.slideDown,
    ...
    SiteList.prototype.render = function () {
      ...
      for (i = 0, len = ref.length; i < len; i++) {
        ...
        if (this.filtering) {
          filter_base =
            site.row.content.title +
            site.row.content.merged_type +
            site.row.address;
          if (
            filter_base.toLowerCase().indexOf(this.filtering.toLowerCase()) ===
            -1
          ) {
            continue;
          }
        ...
        if (site.row.settings.size * 1.2 > site.row.size_limit * 1024 * 1024) {
          ...
          ((ref2 = site.row.settings) != null ? ref2.downloaded : void 0) >
      ...
      return h("div#SiteList", [
        ...
        this.filtering
          ? [
              h(
                ...
                "(found " + num_found + " of " + this.sites.length + " sites)"
              ),
              h(
                "a.filter-clear",
                {
        ...
        this.renderSection(".owned", "Owned sites:", this.sites_owned),
        this.renderSection(
          ".connecting",
          "Connecting sites:",
          this.sites_connecting
        ...
        this.inactive_demo_sites !== null && this.inactive_demo_sites.length > 0
          ? this.renderSection(".more", "More sites:", this.inactive_demo_sites)
          : void 0,
      ]);
    };
  ...
  Chart = (function (superClass) {
      ...
      return Page.cmd(
        ...
        (function (_this) {
          return function (res) {
            ...
            _this.details =
              typeof _this.formatDetails === "function"
                ? _this.formatDetails(type_data)
                : void 0;
            _this.value =
              typeof _this.formatValue === "function"
                ? _this.formatValue(type_data)
                : void 0;
            return Page.projector.scheduleRender();
          };
        })(this)
    ...
    Chart.prototype.updateChart = function () {
      var data,
        ...
        step,
        stroke;
      this.chart_ctx.clearRect(
        0,
        0,
        this.chart_canvas.width,
        this.chart_canvas.height
      );
    ...
    Chart.prototype.render = function () {
      ...
      return h(
        ...
        {
          style:
            "background-image: radial-gradient(at 29% top, #eaaeda05, " +
            this.colorize +
            ")",
        },
        [
          h("div.titles", [
            h("div.title", this.getTitle()),
            h("div.value", this.value),
            h(
              "div.details",
              this.details.map(
                (function (_this) {
  ...
  ChartBig = (function (superClass) {
    ...
    ChartBig.prototype.update = function (cb) {
      ...
      if (Page.params.interval === "1w") {
        ...
        step = 60 * 60;
        query_select =
          "MAX(date_added) AS date_added, type_id, SUM(value) AS value";
        query_group =
      ...
      if (Page.params.date_added_to) {
        date_added_to =
          new Date(Page.params.date_added_to + " 23:59").getTime() / 1000;
        ...
        (function (_this) {
          return function (res) {
            ...
            for (k = 0, len1 = res.length; k < len1; k++) {
              ...
              _this.data[row.type_id][Math.ceil(row.date_added / step) * step] =
                row.value;
              _this.data_max[type_name] = Math.max(
                row.value,
                _this.data_max[type_name]
              );
              _this.data_total[type_name] += row.value;
            }
            _this.configuration.options.scales.yAxes[0].ticks.suggestedMax =
              Math.max(
                _this.data_max["file_bytes_sent"],
                _this.data_max["file_bytes_recv"]
              );
            _this.configuration.options.scales.yAxes[0].ticks.suggestedMin =
              0 -
              _this.configuration.options.scales.yAxes[0].ticks.suggestedMax;
            _this.configuration.options.scales.yAxes[1].ticks.suggestedMax =
              Math.max(
                _this.data_max["request_num_sent"],
                _this.data_max["request_num_recv"]
              );
            _this.configuration.options.scales.yAxes[1].ticks.suggestedMin =
              0 -
              _this.configuration.options.scales.yAxes[1].ticks.suggestedMax;
            for (i = l = 0, len2 = type_ids.length; l < len2; i = ++l) {
              type_id = type_ids[i];
              dataset =
                _this.configuration.data.datasets[_this.types[i].dataset_id];
            ...
            _this.logEnd(
              "Parse result",
              "labels: " + _this.configuration.data.labels.length
            );
            if (_this.chart) {
              _this.chart.update();
            } else {
      ...
      return setInterval(
        (function (_this) {
          return function () {
            ...
            new_data =
              _this.configuration.data.datasets[
                _this.types[0].dataset_id
              ].data.slice();
            ...
            _this.configuration.data.labels.push(
              1000 * (Time.timestamp() + timer_i * 60 * 5)
            );
    ...
    ChartBig.prototype.getChartConfiguration = function () {
      var configuration,
        ...
        gradient_fill_up,
        gradient_stroke,
        gradient_stroke_bgline_down,
        gradient_stroke_bgline_up,
        gradient_stroke_down,
        gradient_stroke_up;
      gradient_stroke = this.createGradientStroke([
        "#5A46DF",
        "#8F49AA",
        "#D64C57",
      ]);
      gradient_stroke_bgline_up = this.createGradientStroke([
        "#EEAAFF11",
        "#EEAAFF33",
        "#2da3b366",
      ]);
      gradient_stroke_bgline_down = this.createGradientStroke([
        "#EEAAFF11",
        "#EEAAFF33",
        "#80623f88",
      ]);
      gradient_stroke_up = this.createGradientStroke([
        "#2b68d9",
        "#2f99be",
        "#1dfc59",
      ]);
      gradient_stroke_down = this.createGradientStroke([
        "#bac735",
        "#c2a548",
        "#f1294b",
      ]);
      ...
      gradient_fill_down = this.createGradientFill(
        ["#45353533", "#f1294b22"],
        "lower"
      );
      configuration = {
          ...
          tooltips: {
            ...
            callbacks: {
              title: function (tootlip_items, data) {
                return Time.date(tootlip_items[0].xLabel, "long").replace(
                  /:00$/,
                  ""
                );
              },
              label: function (tootlip_items, data) {
                if (
                  data.datasets[tootlip_items.datasetIndex].yAxisID ===
                  "Request"
                ) {
                  return (
                    data.datasets[tootlip_items.datasetIndex].label +
                    ": " +
                    Math.abs(tootlip_items.yLabel) +
                    " requests"
                  );
                } else {
                  return (
                    data.datasets[tootlip_items.datasetIndex].label +
                    ": " +
                    Text.formatSize(Math.abs(tootlip_items.yLabel))
                  );
                }
              },
            },
            ...
            yAxes: [
              {
                ...
                gridLines: {
                  ...
                  drawBorder: false,
                  display: true,
                  mojoLineColor: "rgba(255,255,255,0.1)",
                  tickMarkLength: 20,
                  mojoLineBorderDashOffset: 100,
              ...
              },
              {
                ...
                gridLines: {
                  display: false,
                  mojoLineColor: "rgba(255,255,255,0)",
                  drawBorder: false,
                },
              },
            ],
...
(function () {
  ...
  ChartLegend = (function (superClass) {
    ...
    ChartLegend.prototype.render = function () {
      ...
      return h(
        "div.ChartLegend",
        h("div.legend-items.align-left", this.items_left.map(this.renderItem)),
        h("div.legend-items.align-right", this.items_right.map(this.renderItem))
      );
    };
...
(function () {
  ...
  ChartRadar = (function (superClass) {
    ...
    ChartRadar.prototype.update = function () {
      ...
      query =
        "SELECT type_id, site_id, SUM(value) AS sum, value\nFROM data\nWHERE type_id IN :type_ids AND date_added > " +
        (Time.timestamp() - 60 * 60 * 24 * 7) +
        ...
        (function (_this) {
          return function (res) {
            ...
            for (i = k = 0, len1 = ref.length; k < len1; i = ++k) {
              ...
              _this.configuration.data.datasets[0].data[i] = Math.log(
                1 + (stat.site_bw / max_site_bw) * 100
              );
              _this.configuration.data.datasets[1].data[i] = Math.log(
                1 + (stat.site_size / max_site_size) * 100
              );
            }
    ...
    ChartRadar.prototype.renderLabel = function (stat, i) {
      ...
      return h(
        ...
        h(
          ...
          stat.site.row.content.title
        ),
        " ",
        h(
          "span.value",
          " (" + (Text.formatSize(stat[this.order_by]) || "No data yet") + ")"
        )
      );
    };
  ...
  ChartTimeline = (function (superClass) {
          ...
          return function (res) {
            ...
            for (i = l = 7; l >= 1; i = --l) {
              ...
              if (Page.params.interval === "1w") {
                ...
                for (x = m = 0; m <= 6; x = ++m) {
                  day_data +=
                    day_total[Time.dateIso(data_from + 60 * 60 * 24 * x)] || 0;
                }
    ...
    ChartTimeline.prototype.renderItem = function (item) {
      ...
      return h(
        ...
        h("span.data", Text.formatSize(item.data) || "0 MB")
      );
    };
...
(function () {
  ...
  PageStats = (function (superClass) {
    ...
    function PageStats() {
      ...
      this.chart_legend.items_left = [
        {
          ...
          getValue: (function (_this) {
            return function () {
              return Text.formatSize(
                _this.chart_big.data_total.file_bytes_sent
              );
            };
          })(this),
          color: "#1dfc59",
        },
        {
          ...
          getValue: (function (_this) {
            return function () {
              return Text.formatSize(
                _this.chart_big.data_total.file_bytes_recv
              );
            };
          })(this),
          color: "#c94d47",
      ...
      this.chart_connections.type_names = [
        "peer",
        "peer_onion",
        "connection",
        "connection_onion",
      ...
      this.chart_connections.formatDetails = function (type_data) {
        ...
        back.push(
          "Onion: " +
            type_data.peer_onion +
            " peers (" +
            (type_data.connection_onion || 0) +
            " connections)"
        );
        back.push(
          "Incoming: " +
            Math.round((type_data.connection_in / type_data.connection) * 100) +
            "%"
        );
        back.push(
          "Ping avg: " +
            type_data.connection_ping_avg +
            "ms (min: " +
            type_data.connection_ping_min +
            "ms)"
        );
        return back;
      };
      ...
      this.chart_connections.getChartQuery = function () {
        return (
          "SELECT * FROM data WHERE type_id = " +
          Page.page_stats.type_id_db["connection"] +
      ...
      this.chart_size.formatValue = function (type_data) {
        return (
          Text.formatSize(type_data.size) +
          (" in " + Page.site_list.sites.length + " sites")
        );
      };
      this.chart_size.formatDetails = function (type_data) {
        ...
        back.push(
          "Optional downloaded: " +
            (Text.formatSize(type_data.optional_used) || "0 MB") +
            " of " +
            (Text.formatSize(type_data.size_optional) || "0 MB") +
            " (limit: " +
            Text.formatSize(type_data.optional_limit) +
            ")"
        );
        return back;
      };
      this.chart_size.getChartQuery = function () {
        return (
          "SELECT CAST(value AS FLOAT) / 1024 / 1024 AS value FROM data WHERE type_id = " +
          Page.page_stats.type_id_db["size"] +
          " GROUP BY ROUND(date_added / 10000) ORDER BY date_added DESC LIMIT 50"
        );
      };
    ...
    PageStats.prototype.render = function () {
      ...
      if (((ref = Page.server_info) != null ? ref.rev : void 0) < 3220) {
        return h(
          ...
          h("div.empty", [
            ...
            h(
              "small",
              "You have to update to mojoNet version 0.6.1 to use this feature."
            ),
          ])
        );
      }
      ...
      return h("div#PageStats", [
        ...
        this.chartjs_loaded
          ? [
              this.chart_big.render(),
              this.chart_legend.render(),
              this.chart_radar.render(),
              h("div.Charts", [
                this.chart_connections.render(),
                this.chart_size.render(),
              ]),
              this.chart_world.render(),
              this.country_list.render(),
            ]
          : void 0,
      ]);
    };
  ...
  StatList = (function (superClass) {
    ...
    StatList.prototype.render = function () {
      return h("div.StatList", [
        h("h4", "Top country"),
        h("div.stat-list-items", this.items.map(this.renderItem)),
      ]);
    };
  ...
  Animation = (function () {
    ...
    Animation.prototype.slideDown = function (elem, props) {
      var cstyle,
        ...
        transition;
      if (
        (elem.offsetTop > 1000 && elem.getBoundingClientRect().top > 1000) ||
        props.animate_disable
      ) {
        return;
      }
      h = elem.offsetHeight;
    ...
    Animation.prototype.show = function (elem, props) {
      var delay, ref;
      delay =
        ((ref = arguments[arguments.length - 2]) != null ? ref.delay : void 0) *
          1000 || 1;
      elem.style.opacity = 0;
      setTimeout(function () {
...
(function () {
  ...
  Menu = (function () {
    ...
    Menu.prototype.getDirection = function () {
      if (
        this.node &&
        this.node.parentNode.getBoundingClientRect().top + this.height + 60 >
          document.body.clientHeight &&
        this.node.parentNode.getBoundingClientRect().top - this.height > 0
      ) {
        return "top";
      } else {
        return "bottom";
  ...
  document.body.addEventListener("mouseup", function (e) {
    ...
    if (
      ((ref = e.target.parentNode), indexOf.call(menu_parents, ref) < 0) &&
      ((ref1 = e.target.parentNode.parentNode),
      indexOf.call(menu_parents, ref1) < 0)
    ) {
...
(function () {
  ...
  Text = (function () {
    ...
    Text.prototype.emailLinks = function (text) {
      return text.replace(
        /([a-zA-Z0-9]+)@mojoid.bit/g,
        "<a href='?to=$1' onclick='return Page.message_create.show(\"$1\")'>$1@mojoid.bit</a>"
      );
    };
    ...
    Text.prototype.fixHtmlLinks = function (text) {
      if (window.is_proxy) {
        return text.replace(
          /href="http:\/\/(127.0.0.1|localhost):43110/g,
          'href="http://mojo'
        );
      } else {
        return text.replace(
    ...
    Text.prototype.fixLink = function (link) {
      ...
      if (window.is_proxy) {
        back = link.replace(
          /http:\/\/(127.0.0.1|localhost):43110/,
          "http://mojo"
        );
        return back.replace(/http:\/\/mojo\/([^\/]+\.bit)/, "http://$1");
      } else {
    ...
    Text.prototype.fileEncode = function (obj) {
      if (typeof obj === "string") {
        ...
        return btoa(
          unescape(encodeURIComponent(JSON.stringify(obj, void 0, "\t")))
        );
      }
    };
  ...
  window.is_proxy =
    document.location.host === "mojo" || window.location.pathname === "/";
...
(function () {
  ...
  Time = (function () {
    ...
    Time.prototype.dateIso = function (timestamp) {
      ...
      return new Date((timestamp - tzoffset) * 1000)
        .toISOString()
        .split("T")[0];
    };
      ...
      window.addEventListener(
        ...
        (function (_this) {
          return function (e) {
            ...
            return _this.cmd("wrapperReplaceState", [
              _this.history_state,
              null,
            ]);
          };
...
(function () {
  ...
  Head = (function (superClass) {
    ...
    function Head() {
      ...
      this.handleShutdownmojonetClick = bind(
        this.handleShutdownmojonetClick,
        this
      );
      this.handleUpdatemojonetClick = bind(this.handleUpdatemojonetClick, this);
    ...
    Head.prototype.formatUpdateInfo = function () {
      if (
        parseFloat(Page.server_info.version.replace(".", "0")) <
        parseFloat(Page.latest_version.replace(".", "0"))
      ) {
    ...
    Head.prototype.handleLanguageClick = function (e) {
      ...
      if (Page.server_info.rev < 1750) {
        return Page.cmd("wrapperNotification", [
          "info",
          "You need mojoNet 0.5.1 to change the interface's language",
        ]);
      }
    ...
    Head.prototype.renderMenuLanguage = function () {
      ...
      if (
        Page.server_info.language &&
        ((ref = Page.server_info.language), indexOf.call(langs, ref) < 0)
      ) {
    ...
    Head.prototype.handleThemeClick = function (e) {
      ...
      if (Page.server_info.rev < 3670) {
        return Page.cmd("wrapperNotification", [
          "info",
          "You need mojoNet 0.6.4 to change the interface's theme",
        ]);
      }
      ...
      if (theme === "system") {
        if (Page.server_info.rev < 4085) {
          return Page.cmd("wrapperNotification", [
            "info",
            "You need mojoNet 0.7.0 to use system's theme",
          ]);
        }
    ...
    Head.prototype.renderMenuTheme = function () {
      ...
      if (Page.server_info.user_settings.use_system_theme) {
        ...
        theme_selected =
          (ref = Page.server_info.user_settings) != null ? ref.theme : void 0;
        if (!theme_selected) {
          theme_selected = "system";
        }
      }
      return h(
        "div.menu-radio.menu-themes",
        h("div", "Theme: "),
        function () {
          var results;
          results = [];
    ...
    Head.prototype.handleCreateSiteClick = function () {
      if (Page.server_info.rev < 1770) {
        return Page.cmd("wrapperNotification", [
          "info",
          "You need to update your mojoNet client to use this feature",
        ]);
      }
    ...
    Head.prototype.handleBackupClick = function () {
      ...
      return Page.cmd("wrapperNotification", [
        "info",
        "Backup <b>users.json</b> file to keep your identity safe.",
      ]);
    };
    ...
    Head.prototype.handleSettingsClick = function () {
      ...
      this.menu_settings.items.push([
        "Version " +
          Page.server_info.version +
          " (rev" +
          Page.server_info.rev +
          "): " +
          this.formatUpdateInfo(),
        this.handleUpdatemojonetClick,
      ]);
      if (!Page.server_info.multiuser || Page.server_info.multiuser_admin) {
        this.menu_settings.items.push([
          "Shut down mojoNet",
    ...
    Head.prototype.handleManageBlocksClick = function () {
      if (Page.server_info.rev < 1880) {
        return Page.cmd("wrapperNotification", [
          "info",
          "You need mojoNet 0.5.2 to use this feature.",
        ]);
      }
    ...
    Head.prototype.handleUpdatemojonetClick = function () {
      if (Page.server_info.updatesite) {
        ...
        Page.cmd(
          ...
          [
            ...
            "Update mojoNet " + Page.latest_version,
          ],
          (function (_this) {
            return function () {
              return Page.updatemojonet();
    ...
    Head.prototype.handleShutdownmojonetClick = function () {
      return Page.cmd(
        "wrapperConfirm",
        ["Are you sure?", "Shut down mojoNet"],
        (function (_this) {
          return function () {
            return Page.cmd("serverShutdown");
          };
    ...
    Head.prototype.handleModeClick = function (e) {
      if (Page.server_info.rev < 1700) {
        Page.cmd("wrapperNotification", [
          "info",
          "This feature requires mojoNet version 0.5.0",
        ]);
      } else {
...
(function () {
  ...
  mojoHello = (function (superClass) {
    extend(mojoHello, superClass);
    ...
    function mojoHello() {
      ...
      return mojoHello.__super__.constructor.apply(this, arguments);
    }

    mojoHello.prototype.init = function () {
      this.params = {};
      this.site_info = null;
    ...
    mojoHello.prototype.addRenderer = function (node, renderer) {
      this.projector.replace(node, renderer);
      return this.renderers.push(renderer);
    };

    mojoHello.prototype.detachRenderers = function () {
    ...
    mojoHello.prototype.setProjectorMode = function (mode) {
    ...
    mojoHello.prototype.createProjector = function () {
      var url;
    ...
    mojoHello.prototype.route = function (query) {
    ...
    mojoHello.prototype.createUrl = function (key, val) {
      var params, vals;
    ...
    mojoHello.prototype.setUrl = function (url, mode) {
      if (mode == null) {
        mode = "replace";
      }
      url = url.replace(/.*?\?/, "");
    ...
    mojoHello.prototype.handleLinkClick = function (e) {
      if (e.which === 2) {
        return true;
      } else {
    ...
    mojoHello.prototype.loadSettings = function () {
          ...
          return function () {
            return _this.cmd("userGetSettings", [], function (res) {
              ...
              if (!res || res.error) {
                ...
                _this.feed_list.date_feed_visit =
                  _this.settings.date_feed_visit;
    ...
    mojoHello.prototype.loadLocalStorage = function () {
      return this.cmd(
    ...
    mojoHello.prototype.saveSettings = function (cb) {
      if (this.settings) {
    ...
    mojoHello.prototype.onOpenWebsocket = function (e) {
      this.reloadServerInfo();
      this.reloadServerErrors();
      return this.reloadSiteInfo();
    };

    mojoHello.prototype.reloadSiteInfo = function () {
      return this.cmd(
        "siteInfo",
        {},
        (function (_this) {
    ...
    mojoHello.prototype.reloadServerInfo = function (cb) {
      return this.cmd(
        "serverInfo",
        {},
        (function (_this) {
    ...
    mojoHello.prototype.reloadServerErrors = function (cb) {
      return this.on_server_info.then(
        (function (_this) {
          return function () {
            if (
              _this.server_info.multiuser &&
              !_this.server_info.multiuser_admin
            ) {
    ...
    mojoHello.prototype.reloadAnnouncerInfo = function (cb) {
      return this.cmd(
        "announcerInfo",
        {},
        (function (_this) {
    ...
    mojoHello.prototype.reloadAnnouncerStats = function (cb) {
      return this.cmd(
        "announcerStats",
        {},
        (function (_this) {
    ...
    mojoHello.prototype.onRequest = function (cmd, params) {
      if (cmd === "setSiteInfo") {
    ...
    mojoHello.prototype.setSiteInfo = function (site_info) {
      var ref, ref1;
      if (site_info.address === this.address) {
        ...
        if (((ref = this.server_info) != null ? ref.rev : void 0) > 3530) {
          ...
          ((ref1 = this.server_info) != null ? ref1.rev : void 0) > 3460
        ) {
    ...
    mojoHello.prototype.setServerInfo = function (server_info) {
      var ref;
      ...
      if (
        ((ref = server_info.event) != null ? ref[0] : void 0) === "log_event"
      ) {
        RateLimit(
          1000,
          (function (_this) {
    ...
    mojoHello.prototype.setServerErrors = function (server_errors) {
    ...
    mojoHello.prototype.setAnnouncerInfo = function (announcer_info) {
      this.announcer_info = announcer_info.stats;
      return this.projector.scheduleRender();
    };

    mojoHello.prototype.returnFalse = function () {
      return false;
    };

    mojoHello.prototype.updatemojonet = function () {
      if (this.server_info.updatesite) {
        return (window.top.location = Text.getSiteUrl(
          this.server_info.updatesite
        ));
      } else {
        Page.cmd("wrapperNotification", [
          "info",
          "Updating to latest version...<br>Please restart mojoNet manually if it does not come back in the next few minutes.",
          8000,
        ]);
